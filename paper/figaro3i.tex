...
diplomatic recognition as a sovereign-equivalent entity. The
sequence is presented as a contemporary updating of
Hirschman's framework on \emph{exit} as a response to
institutional dissatisfaction (\citealt{hirschman1970exit}): when
voice within incumbent states becomes ineffective, exit to a
new entity becomes the alternative, but exit requires a
destination, and the network state is the destination's design.

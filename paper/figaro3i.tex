...
This paper observes that the bonded settlement primitive admits
a third option that neither program names: an \emph{ungoverned
substrate} on which arbitrary
...
that the political-philosophy treatment of coercion left open:
when the state's sovereign-coercive function is partially
...
The bonded settlement primitive provides a different option that
...
diagnostic, nor does it extend the political-philosophy of
coercion. It engages two contemporary research
...
This paper extends the political-philosophy treatment of
coercion as a substrate variable. That treatment identified
coercion as structurally load-bearing in the dominant
...
to the graph for arrangements that require it. Together these
treatments complete the substrate-relocation argument for the
political-philosophy register, as parallel institutional and
political-economy treatments did for the firm and the left/right
partition.
...
more public of the two programs and because the political-economy
diagnostic of hegemony identified its specific unsolved
sub-problem as one the bonded primitive resolves.
...
participants' physical jurisdictions. The political-economy
diagnostic of hegemony noted that this is not a minor
implementation detail: the missing economic engine is the
...
settlement primitive is such an architecture. The kernel has no
admin, no owner,
...
verified implementation documents how this is achieved for the
bonded primitive: a kernel of approximately two hundred
...
disputes under conventional doctrines, in the jurisdictional
environments within which the parties operate,
...
assembly --- a transaction-scoped arrangement of bonded
commitments among multiple parties. A
...
property the accounting analysis develops more fully; from the
present paper's perspective the property matters because it
...
network entity. The bonded settlement primitive realizes a third
option that neither program names: an ungoverned substrate,
invariant by
...
the bonded settlement primitive being one such case --- the
ungoverned-substrate option is available, and
...
ideologically agnostic; the graph is the politics --- and the
present paper extends this formulation in a fourth direction.
The political-economy diagnostics showed that subordination and
coordination rent become graph-tier choices when the substrate
removes them as load-bearing variables. The political-philosophy
treatment of coercion showed that coercion becomes a bounded
political-philosophical question when the substrate substitutes
pre-commitment for retributive enforcement. The present paper shows that governance becomes a
...
political-philosophy treatment of coercion to engage two
specific contemporary programs by name. The Network State
program was already in scope as a remark in that treatment; the
...
acknowledged in the political-economy treatment of hegemony;
the present engagement is meant in the spirit of that
...
neither to absorb the adjacent programs into this framing nor to
dismiss them, but to identify where this framing supplies an
architectural option the adjacent programs have not yet had
occasion to name.

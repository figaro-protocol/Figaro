...
in~\citep{daliana2026impl}, changes the doctrinal terrain by
...
in~\citep{daliana2026mechanism} and implemented
in~\citep{daliana2026impl} changes the question. Its companion
institutional-economics paper~\citep{daliana2026tce} develops the
...
institutional-economics companion~\citep[§3.1]{daliana2026tce},
...
mechanism is established in~\citep{daliana2026mechanism}; the
Solidity implementation and formal verification
in~\citep{daliana2026impl}; the evidentiary framework for off-chain
dispute adjudication in~\citep{daliana2026legal}.
...
consume~\citep{daliana2026legal}. The wallet is the productive
...
\begin{enumerate}[label=(\alph*)]
  ...
  \item \textbf{Credentialing is self-attached.} At the protocol
    ...
    in~\citep[§1.4]{daliana2026mechanism}), schema-validated
...
paper~\citep{daliana2026accounting} develops the argument
...
institutional-economics companion~\citep[§3]{daliana2026tce} is
...
This paper, along with the institutional-economics
companion~\citep{daliana2026tce}, the political-economy
companion~\citep{daliana2026hegemony}, and the electronic-evidence
companion~\citep{daliana2026legal}, each individually disclaims
...
\bibitem[Daliana(2026e)]{daliana2026accounting}
Daliana, A.

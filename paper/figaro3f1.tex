...
inherits per the companion evidence-and-law paper).
...
A scope condition that the present paper has not yet named, and
that the companion mechanism paper makes explicit in its
conclusion, deserves treatment here. The mechanism's equilibrium
results hold under the assumption that both parties are legally
and materially free to enter the bonding game --- that entering

...
\begin{itemize}
  ...
  \item \emph{Customs authority}: payment for the import duty.
    The customs-authority wallet is an RWA-as-wallet of the same
    kind as a commercial provider --- a public service sustained
    by receipts covering its operating expenses --- in the role
    of a bonded seller of border-clearance service. The
    sovereign decisional authority on the customs agent's
    parallel attestation is an off-chain regulatory function

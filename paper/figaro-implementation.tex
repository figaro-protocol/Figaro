% Figaro Paper C: A Verified Solidity Implementation of Asymmetric Bonding
% and Buyer Dominance.
...
\title{%
  ...
  A Verified Solidity Implementation%
}
...
A Foundry test suite (31 files, 420 tests as of snapshot date)
...
31 test suites, 420 tests (including

...
The wallet-as-legal-subject argument that underwrites the companion
labor-law paper extends here in a different
...
labor-law paper; the present paper develops the
...
companion labor-law paper (§4) develops
...
constraint is not minor: the companion mechanism paper makes
explicit in its conclusion that the equilibrium results assume
both parties are legally and materially free to enter the bonding
...
labor-law side (the labor-law paper), is to make the
...
the companion labor-law paper toward

...
Coasean assumption examined in the companion
institutional-economics paper) and that cross-border trade requires
...
arbitrator. The mechanism is established in the companion
mechanism paper; the implementation and formal
verification in the companion implementation paper; the institutional-economic
implications for the boundary of the firm in the companion
institutional-economics paper. The present paper takes those
...
It does not extend the mechanism of the companion mechanism paper,
...
\begin{enumerate}
  ...
  \item \textbf{Production requires firms.}
    Examined in detail in the companion institutional-economics paper:
...
subject of the \emph{coordinator pattern} developed in §7 of the
companion implementation paper, which we
...
institutional-economics, mechanism, and implementation papers

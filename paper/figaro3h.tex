...
or external authority. The mechanism is what
...
Pettit), and in adjudicating among competing visions of the good
...
\paragraph{Not Hobbesian, not Schmittian.}
The paper does not argue that Hobbes was right that a
sovereign is necessary because the bonded mechanism substitutes
for that necessity in commerce; nor does it argue that
\citet{schmitt1922politicaltheology} was right that sovereignty is
defined by the decision on the exception, because the bonded
mechanism does not address exception. Hobbes's structural
observation about covenants without swords is satisfied by a
different mechanism in the substituting domain, and is not
revisited in the non-substituting domain. Schmitt's analysis of
sovereignty as decision under exception is orthogonal to the
substitution and is not addressed.

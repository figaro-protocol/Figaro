...
performs the enforcement function of law in bilateral commerce
\emph{without} a coercive apparatus in the tradition's sense. There is no third party who applies force
...
Much of that work is sustained not by force but by belief:
institutional legitimacy carried by ritual, doctrine, education,
and the daily operation of trusted bodies --- a parallel pillar
of rule-stabilization that the social-theory tradition since
\citet{weber1919} has read alongside coercion. The bonded
primitive partially displaces the coercive pillar in bilateral
commerce; it operates alongside the legitimacy-by-belief pillar
without substituting for it.
...
The bonded settlement primitive performs the enforcement
function for bilateral commercial obligations \emph{without} a
coercive apparatus in the tradition's sense. The bond is locked at the
...
institutional argument, or the political-economy diagnostic. It
takes those contributions as given and asks what their joint
implication is for the philosophical analysis of coercion that
has organized political thought from Hobbes to the present.
...
This paper sits in the law-and-civil-authority register
alongside parallel treatments of subordination as legal axis and
of civil-status preconditions. It addresses what those
treatments presuppose: the coercive apparatus that historically
stands behind both labor contracts and civil status, and what
the substrate change implies for that apparatus when its
commercial-enforcement function is substituted by bond. Adjacent
to this paper are the institutional-economic, hegemonic-visibility,
and partition-conditionality questions, each treated in its own
register. The present paper addresses the political-philosophy
question those treatments bracket: what is removed when coercion
is removed, and what continues to require it.

% ════════════════════════════════════════════════════════════════════
\section{Coercion as the Third Substrate Variable}
\label{sec:third-variable}

The partition-conditionality argument identifies two substrate
variables --- subordination and coordination rent --- on which
the disagreement between the cooperative-Marxian and
...
The framing tracks the partition-conditionality treatment of
subordination as a substrate variable. Both moves rely on
...
its own register; we summarize only what is necessary for the
present argument.
...
That question requires its own treatment, separate from this
one. The present paper notes only
...
commitment as evidentiary input. The exception is not absorbed by
...
ideologically agnostic; the graph is the politics.

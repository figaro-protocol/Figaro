...
conditions is not currently in the verification stack. The open
question is whether parametric verification at the coordinator-pattern
level is worth the work, or whether per-coordinator verification
suffices.

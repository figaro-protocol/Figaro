...
observability \citep{liu2024agentobserve} is the third leg:
...
\bibitem[Liu et~al.(2024)]{liu2024agentobserve}
Liu, T., Bommasani, R., and Liang, P.
\newblock Observability for {LLM}-Augmented Agents: Logging,
  Replay, and Failure-Mode Analysis.

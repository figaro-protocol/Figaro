...
% ════════════════════════════════════════════════════════════════════
\begin{abstract}
The bonded settlement primitive of the companion mechanism paper is
analyzed there as a full-rationality mechanism: cooperation is the
...
The companion mechanism paper of this corpus
(Paper~A) proves that cooperation is weakly dominant for both
parties in the bonded game, and is the unique profile surviving
...
verified in the companion implementation paper through
...
The contribution of this paper is the behavioral analysis. The
mechanism-design contribution is in the companion mechanism paper.
The combined argument is that the bonded primitive is both
formally elegant under full rationality and behaviorally robust
...
The behavioral analysis builds on the mechanism-design work of
the companion mechanism paper and on the externality-engagement
treatment in the political-economy and coercion companion papers.

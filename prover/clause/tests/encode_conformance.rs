...
fn fulfilment_delivery_only() {
    // Current 2-field spec shape (handoffPoints split into figaro-handoff-v1):
    // modalities ["delivery"] → [2] in [consume-onsite, pickup, delivery, virtual];
    // delivery.coordination ["buyer-assigned"] → [1] in
    ...
    assert_encode(
        ...
        "",
    );
}

...
/// The 20 runtime-attestable protocol clauses.
const EMBEDDED_SPECS: &[EmbeddedSpec] = &[
    ...
    embed!("figaro-modalities-v1"),
    embed!("figaro-coordination-v1"),
...
/// is not one of the 20 runtime-attestable protocol clauses (third-party

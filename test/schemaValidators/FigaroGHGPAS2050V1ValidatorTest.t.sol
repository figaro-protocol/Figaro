...
contract FigaroGHGPAS2050V1ValidatorTest is Test {
    FigaroGHGPAS2050V1Validator validator;
    bytes32 constant ID = keccak256("figaro-ghg-pas-2050-v1");
    ...
    function test_rejectsScopeAboveThree() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(FigaroGHGPAS2050V1Validator.InvalidScope.selector, uint8(4)));
        validator.validate(ID, 0, c, c);
    }

    function test_rejectsMismatchedSchemaId() public {
        bytes memory c = _call(0);
        bytes32 other = keccak256("not-pas-2050");
        vm.expectRevert(
            abi.encodeWithSelector(FigaroGHGPAS2050V1Validator.SchemaIdMismatch.selector, other, ID)
        );
    ...
    function test_rejectsSectionDataMismatch() public {
        ...
        vm.expectRevert(FigaroGHGPAS2050V1Validator.SectionDataMismatch.selector);

...
import {FigaroApplicableLawV1Validator} from "../../src/schemaValidators/FigaroApplicableLawV1Validator.sol";
...
contract FigaroApplicableLawV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedSchemaId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FigaroApplicableLawV1Validator.SchemaIdMismatch.selector, other, ID)
        );

...
import {FigaroGHGMeasurementV1Validator} from "../../src/schemaValidators/FigaroGHGMeasurementV1Validator.sol";
...
contract FigaroGHGMeasurementV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedSchemaId() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(FigaroGHGMeasurementV1Validator.SchemaIdMismatch.selector, other, ID));

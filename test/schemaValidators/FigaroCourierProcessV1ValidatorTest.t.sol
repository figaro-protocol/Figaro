...
import {FigaroCourierProcessV1Validator} from "../../src/schemaValidators/FigaroCourierProcessV1Validator.sol";
...
contract FigaroCourierProcessV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedSchemaId() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(FigaroCourierProcessV1Validator.SchemaIdMismatch.selector, other, ID));

...
import {FigaroGHGEN16258V1Validator} from "../../src/schemaValidators/FigaroGHGEN16258V1Validator.sol";

contract FigaroGHGEN16258V1ValidatorTest is Test {
    FigaroGHGEN16258V1Validator validator;
    bytes32 constant ID = keccak256("figaro-ghg-en-16258-v1");
    ...
    function test_rejectsScopeAboveThree() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(FigaroGHGEN16258V1Validator.InvalidScope.selector, uint8(4)));
        validator.validate(ID, 0, c, c);
    }

    function test_rejectsMismatchedSchemaId() public {
        bytes memory c = _call(0);
        bytes32 other = keccak256("not-en-16258");
        vm.expectRevert(
            abi.encodeWithSelector(FigaroGHGEN16258V1Validator.SchemaIdMismatch.selector, other, ID)
        );
    ...
    function test_rejectsSectionDataMismatch() public {
        ...
        vm.expectRevert(FigaroGHGEN16258V1Validator.SectionDataMismatch.selector);

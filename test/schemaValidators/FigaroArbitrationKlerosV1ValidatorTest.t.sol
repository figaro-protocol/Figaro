...
import {FigaroArbitrationKlerosV1Validator} from "../../src/schemaValidators/FigaroArbitrationKlerosV1Validator.sol";
...
contract FigaroArbitrationKlerosV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedSchemaId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FigaroArbitrationKlerosV1Validator.SchemaIdMismatch.selector, other, ID)
        );

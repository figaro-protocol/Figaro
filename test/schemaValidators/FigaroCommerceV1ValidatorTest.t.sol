...
import {FigaroCommerceV1Validator} from "../../src/schemaValidators/FigaroCommerceV1Validator.sol";
...
contract FigaroCommerceV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedSchemaId() public {
        ...
        FigaroCommerceV1Validator.LineItem[] memory items = new FigaroCommerceV1Validator.LineItem[](0);
        bytes memory c = _call(CURRENCY, 1e18, items);
        vm.expectRevert(abi.encodeWithSelector(FigaroCommerceV1Validator.SchemaIdMismatch.selector, other, ID));

...
contract ClauseRegistryTest is Test {
    ...
    // integrity digest.
    string constant FULFILMENT_ID = "figaro-fulfilment-v2";
    bytes32 constant FULFILMENT_HASH = keccak256("figaro-fulfilment-v2");
    string constant FULFILMENT_URI = "ipfs://figaro-fulfilment/v2";
    bytes32 constant FULFILMENT_CONTENT = keccak256("figaro-fulfilment-v2-spec");
    ...
    function test_registerClause() public {
        vm.prank(alice);
        registry.registerClause(FULFILMENT_ID, 1, FULFILMENT_CONTENT, FULFILMENT_URI, FULFILMENT_FAMILY);

        assertTrue(registry.registered(FULFILMENT_HASH));
    }
    ...
    function test_registerClause_revertsOnDuplicate() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ClauseRegistry.AlreadyRegistered.selector, FULFILMENT_HASH));
        registry.registerClause(FULFILMENT_ID, 2, FULFILMENT_CONTENT, FULFILMENT_URI, FULFILMENT_FAMILY);
    }

    function test_unregisteredClause_returnsFalse() public view {
        assertFalse(registry.registered(FULFILMENT_HASH));
    }
    ...
    function test_registerClause_revertsZeroFamily() public {
        ...
        registry.registerClause(FULFILMENT_ID, 1, FULFILMENT_CONTENT, FULFILMENT_URI, bytes32(0));
    }
    ...
    function test_emitsClauseRegistered() public {
        ...
        emit ClauseRegistry.ClauseRegistered(
            FULFILMENT_ID, 1, FULFILMENT_CONTENT, FULFILMENT_URI, FULFILMENT_FAMILY, address(this)
        );
        registry.registerClause(FULFILMENT_ID, 1, FULFILMENT_CONTENT, FULFILMENT_URI, FULFILMENT_FAMILY);
    }
    ...
    function test_setMechanismClause() public {
        ...
        vm.prank(mechanism);
        registry.setMechanismClause(FULFILMENT_HASH);
        // Success = no revert. Event verified below.
    }

    function test_setMechanismClause_revertsOnUnregistered() public {
        vm.prank(mechanism);
        vm.expectRevert(abi.encodeWithSelector(ClauseRegistry.NotRegistered.selector, FULFILMENT_HASH));
        registry.setMechanismClause(FULFILMENT_HASH);
    }
    ...
    function test_setMechanismClause_emitsEvent() public {
        ...
        emit ClauseRegistry.MechanismClauseSet(mechanism, FULFILMENT_HASH);
        registry.setMechanismClause(FULFILMENT_HASH);
    }
    ...
    function test_registerClause_revertsZeroContentHash() public {
        ...
        registry.registerClause(FULFILMENT_ID, 1, bytes32(0), FULFILMENT_URI, FULFILMENT_FAMILY);
    }

    function test_registerClause_revertsEmptyMetadataURI() public {
        vm.prank(alice);
        vm.expectRevert(ClauseRegistry.EmptyMetadataURI.selector);
        registry.registerClause(FULFILMENT_ID, 1, FULFILMENT_CONTENT, "", FULFILMENT_FAMILY);
    }

    function test_registerClause_revertsEmptyClauseId() public {
        vm.prank(alice);
        vm.expectRevert(ClauseRegistry.EmptyClauseId.selector);
        registry.registerClause("", 1, FULFILMENT_CONTENT, FULFILMENT_URI, FULFILMENT_FAMILY);
    }

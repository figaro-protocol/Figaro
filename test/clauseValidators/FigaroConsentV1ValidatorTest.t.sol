...
import {FigaroConsentV1Validator} from "../../src/clauseValidators/FigaroConsentV1Validator.sol";
...
contract FigaroConsentV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedClauseId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FigaroConsentV1Validator.ClauseIdMismatch.selector, other, ID)
        );

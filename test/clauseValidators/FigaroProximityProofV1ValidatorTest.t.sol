...
import {FigaroProximityProofV1Validator} from "../../src/clauseValidators/FigaroProximityProofV1Validator.sol";
...
contract FigaroProximityProofV1ValidatorTest is Test {
    ...
    function test_rejectsMismatchedClauseId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FigaroProximityProofV1Validator.ClauseIdMismatch.selector, other, ID)
        );

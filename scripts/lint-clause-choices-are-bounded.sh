...
FREE_CONTENT='^(currency|nonce|.*[Ss]ig|.*[Uu]ri|.*[Hh]ash|.*[Gg]eohash|description|name|properShippingName|unNumber|incotermsNamedPlace|credentialId|tagline|specialty|notes?|custodyScheme|acceptanceBasis|licenseScope)$'

...
#     /assemblies/designer (the editable AgreementDrawer + buildAssemblyTemplate).
...
#   - app/(tools)/assemblies/designer/   (the designer surface — canvas + drawer)
...
ALLOWED_1='app/(tools)/assemblies/designer/'
...
if (( violations > 0 )); then
    ...
    echo "belongs ONLY in app/(tools)/assemblies/designer/. Sellers BIND published assemblies;"

...
- **Bond-multiplier tuning — ">1× suffices", reputation-weighted bonds, capital-efficiency discounts** → the 2× multiplier is mechanism-design DOCTRINE (ruled 2026-07-14), not a parameter to minimize; any lower/variable-multiplier proposal is traditional-finance capital-efficiency reasoning re-entering the project. Delete on sight; `lint-no-closed-world-vocab.sh` enforces.

...
| Principle | Why |
|---|---|
| **Publication, not product** | No funnel. No "Get started" CTA at the top of the homepage. Reading paths, not conversion paths. Per `feedback_protocol_not_product_ui.md`. |
...
| **No segment routers** | Per `feedback_protocol_not_product_ui.md` — don't ask "are you a buyer / seller / developer?" The protocol is actor-neutral. |
| **No badges next to names** | Per `feedback_no_badges.md` — no "Reference Archetype" labels in nav. |

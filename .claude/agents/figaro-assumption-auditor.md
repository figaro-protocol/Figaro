...
- `~/.claude/projects/-Users-adaliana/memory/feedback_web2_drift.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_no_tangling.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_detail_limits.md`
- `~/.claude/projects/-Users-adaliana/memory/project_zargham_taxonomy.md`
- `~/.claude/projects/-Users-adaliana/memory/project_two_audience_marketing_architecture.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_protocol_not_product_ui.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_horizontal_pages.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_marketing_conservative.md`
- `~/.claude/projects/-Users-adaliana/memory/feedback_no_web2.md`
...
- "Schema/contract/assembly W" — grep the `src/` tree.
...
2. **Tangling** — marketing copy on `(app)/` surfaces; `(app)/` catalogues (schemas, mechanisms, assemblies) on marketing pages; merging audiences the project has separated (readers + contributors on one page).
...
5. **Catalogue-on-marketing** — listing 18 schemas, the Dutch auction, or the 5 reference assemblies on a marketing page. Marketing communicates; it does not catalogue. The catalogue lives on `(app)/`.

...
- **Protocol** = extension contracts (`SchemaRegistry.sol`, `AttestationCoordinator.sol`, `OperatorRegistry.sol`, `DutchAuction.sol`, `schemaValidators/*`, `FigaroBatchVerifier.sol`). Extension doctrine in `docs/v5/SCHEMAS.md` applies.

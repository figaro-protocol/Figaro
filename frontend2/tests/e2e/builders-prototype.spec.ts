...
// Assembly list + eats shell rendering → builders-prototype.shared.spec.ts

test.describe('Builder prototype route — mock-only', () => {
    test('renders a second assembly through the same prototype shell', async ({ page }) => {
    ...
    test('renders a disclosure-first assembly with a narrower visible module surface', async ({ page }) => {

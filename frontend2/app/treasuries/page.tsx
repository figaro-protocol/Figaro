        ...
        <>
            ...
            <section className="container mx-auto px-6 pb-12 max-w-3xl border-t border-gray-200 pt-12">
                ...
                <p className="text-sm text-gray-600">
                    Paper G treatment of the accounting substrate: <Link href="/accounting" className="underline">/accounting</Link>.
                </p>
            </section>
            ...
            <section className="container mx-auto px-6 pb-24 max-w-3xl border-t border-gray-200 pt-12">
                ...
                <ul className="space-y-3 text-sm text-gray-700 leading-relaxed list-disc pl-6">
                    ...
                    <li><strong>No kernel-level arbitration.</strong> The protocol produces evidence; the agreement specifies the forum. See <Link href="/about#enforcement" className="underline">enforcement</Link> and <Link href="/legal" className="underline">/legal</Link>.</li>

        ...
        <div className="min-h-screen bg-neutral-50">
            <section className="container mx-auto px-6 pt-24 pb-12 max-w-3xl">
                ...
                <p className="text-base text-neutral-600 leading-relaxed max-w-2xl">
                    Every assembly inherits the four baseline graphs — capital flow, geolocation, GHG, and DAG topology — automatically. On top of the baseline, you add components (today: Dutch auction) that bundle their own schemas, backend, and UI.
                </p>
                <div className="mt-8">
                    <Link

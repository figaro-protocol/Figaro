...
/**
 * useProcessOrders — central event-based order hook (V5).
 *
 ...
 *
 * V5 simplification: unified commit(), no parentOrderHashes, events carry
 * salt+deadline instead of bonds/timestamps. Bonds are computed from payment
 * and cumulativeValue.
 */

            ...
            <View style={styles.table}>
                ...
                {contract.clauses.map((clause) => (
                    <View key={clause.schemaKey} style={styles.tableRow}>
                        <Text style={[styles.tCellMono, { flex: 2 }]}>{clause.schemaKey}</Text>
...
function InvoicePage({ invoice }: { invoice: AuditBundle["invoice"] }) {
    ...
    return (
        <Page size="A4" style={styles.page}>
            ...
            <Text style={styles.h2}>Line items ({invoice.lineItems.length})</Text>
            <View style={styles.table}>
                <View style={[styles.tableRow, styles.tableHeader]}>
...
function BillOfLadingPage({ bol }: { bol: AuditBundle["billOfLading"] }) {
    return (
        <Page size="A4" style={styles.page}>
            <View style={styles.header}>

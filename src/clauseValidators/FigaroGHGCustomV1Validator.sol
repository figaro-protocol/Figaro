...
///         document; this clause only commits to the scope dimension.
///
...
///      standards. Use this clause only when none of the above applies.
contract FigaroGHGCustomV1Validator is IClauseValidator {
    bytes32 public constant override clauseId = keccak256("figaro-ghg-custom-v1");

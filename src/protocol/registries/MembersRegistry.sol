...
contract MembersRegistry {
    ...
    ///         read the RPGF path gates on, at RECORD time: a resolved process's
    ...
    ///         withdrawal clears the guard and makes the member's resolved-but-
    ///         unrecorded trades unrecordable for the rest of the period, not
    ///         merely their future ones (usage is recorded at resolution to close

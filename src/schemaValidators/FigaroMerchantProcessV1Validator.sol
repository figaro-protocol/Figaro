...
///      under this schema as the SSoT for "what the merchant has done." The
...
///      process schema; their evidence IS the kernel event log. See
///      `CLAUDE.md` "Adding a new schema" checklist for the discipline.
///
...
contract FigaroMerchantProcessV1Validator is ISchemaValidator {
    bytes32 public constant override schemaId = keccak256("figaro-merchant-process-v1");

...
///
/// @dev Runtime-only (Category-1) schema. The committed agreement section
...
///      Contrast with the `figaro-ghg-<standard>-v1` sister schemas
...
///      the schemaId, so each accounting standard has its own sister schema.
///
...
contract FigaroGHGMeasurementV1Validator is ISchemaValidator {
    bytes32 public constant override schemaId = keccak256("figaro-ghg-measurement-v1");

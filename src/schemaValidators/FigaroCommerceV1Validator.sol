...
contract FigaroCommerceV1Validator is ISchemaValidator {
    bytes32 public constant override schemaId = keccak256("figaro-commerce-v1");
    ...
    ///      later attest different commerce terms under the same schema.

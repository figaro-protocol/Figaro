...
///      under this schema as the SSoT for "what the courier has done." The
...
contract FigaroCourierProcessV1Validator is ISchemaValidator {
    bytes32 public constant override schemaId = keccak256("figaro-courier-process-v1");

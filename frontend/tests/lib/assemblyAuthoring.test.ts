...
describe('assembly authoring helpers', () => {
    ...
    it('clones an existing assembly and rewrites top-level identity-bound fields', () => {
        ...
        expect(assembly.narrative?.institutionSummary).toContain('Figaro Returns as a scaffold cloned from figaro-procurement');
...
export const FIGARO_RETURNS_REFERENCE_ASSEMBLY = parseInstitutionAssemblyDocument(

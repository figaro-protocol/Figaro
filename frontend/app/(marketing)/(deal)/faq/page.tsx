    ...
    return (
        <>
            ...
            <MarketingSection title="Can someone hijack your registration or clause?" sectionId="builders-registries">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    All three registries &mdash; <code>ClauseRegistry</code>, <code>AssemblyRegistry</code>, and <code>MembersRegistry</code> &mdash; are anchored by the same anti-spam mechanism: a reclaimable stake, a different deposit from the trade bond described above &mdash; staked intent, priced to deter spam, not a party&apos;s deterrent against its own defection. No admin can seize it; withdrawing reclaims the exact amount and de-surfaces the registration (readers hide what carries no live stake), so polluting a registry costs deposit &times; the time it stayed surfaced. The amount is set per deployment &mdash; read it with <code>registrationDeposit()</code> on the registry you are registering against, never from a remembered constant.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

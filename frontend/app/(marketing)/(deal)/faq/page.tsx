    ...
    return (
        <>
            ...
            <MarketingSection title="Can this website lie about what you're signing?" sectionId="signing">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The definitive, non-technical answer to this whole question &mdash; a verifiable build, where no single origin&apos;s word is required at all &mdash; is the Security page&apos;s subject; until then, the two checks above are the check.
                </p>
                <p className="text-base text-ink-body leading-relaxed">

        ...
        <>
            ...
            <MarketingSection title="Before your first real trade." sectionId="before-you-send">
                ...
                <ul className="space-y-3 text-base text-ink-body mb-5 ml-6">
                    ...
                    <li>&mdash; <strong className="text-ink-heading font-medium">Can this website lie about what I am signing?</strong> Not about a trade already committed &mdash; the gap is the moment just before you sign, and closing it means running one of two checks yourself, with developer tools (<Link href="#signing" className="text-ink-heading font-medium hover:underline">both checks, step by step</Link>).</li>
            ...
            <MarketingSection title="What stands behind a trade?" sectionId="layers">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    Five things, each a reason the trade goes right, stacked from the inside out. The bonds behind them are deterrents &mdash; not a fund anyone draws on, and not property anyone seizes &mdash; and the innermost layers do almost all the work. The outer layers exist only for the residue the inner ones cannot reach.
                </p>
                <LayeredDefenseFigure className="mb-6" />
                <ul className="space-y-3 text-base text-ink-body mb-5 ml-6">
                    <li>&mdash; <strong className="text-ink-heading font-medium">The chain.</strong> The trade runs on Ethereum. Once its data is written, no one can rewrite it &mdash; not a counterparty, not Figaro, not the party who wrote it.</li>
                    <li>&mdash; <strong className="text-ink-heading font-medium">The lockbox and its data.</strong> FigaroCore holds both sides&apos; doubled stakes by fixed rule, and writes an unforgeable, timestamped entry for every step as it happens &mdash; always, not on request. Nothing leaves the lockbox until the buyer signs the resolution.</li>
                    <li>&mdash; <strong className="text-ink-heading font-medium">The other sellers.</strong> Resolution is all-or-nothing: no one is paid until the buyer confirms the whole trade. So everyone bonded into it has their own stake-backed reason to help set right whatever went wrong, before there is anything to dispute.</li>
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The outer two layers act on the data from outside the trade; neither can reach into the lockbox. That is the point of the no-escape-hatch design &mdash; the same wall that keeps anyone from prying the stakes out also keeps every step legible to whoever reads the data later.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
            ...
            <MarketingSection title="Can someone hijack your registration or clause?" sectionId="builders-registries">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    All three registries &mdash; <code>ClauseRegistry</code>, <code>AssemblyRegistry</code>, and <code>MembersRegistry</code> &mdash; are anchored by the same anti-spam mechanism: a reclaimable stake &mdash; staked intent, priced to deter spam. No admin can seize it; withdrawing reclaims the exact amount and de-surfaces the registration (readers hide what no longer carries a live stake), so polluting a registry costs deposit &times; the time it stayed surfaced. The amount is set per deployment &mdash; read it with <code>registrationDeposit()</code> on the registry you are registering against, never from a remembered constant.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

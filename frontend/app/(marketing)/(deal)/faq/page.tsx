    ...
    return (
        <>
            ...
            <MarketingSection title="Can this website lie about what you're signing?" sectionId="signing">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The definitive, non-technical answer to this whole question is a verifiable build: a release pinned by its own content hash (a CID) with a published rebuild recipe anyone can diff against it, plus a second, independently built frontend attesting to the same typed data &mdash; so no single origin&apos;s word is required at all. Wherever no second frontend is at hand, the two checks above are the check, and the limitation below stands as written.
                </p>
                <p className="text-base text-ink-body leading-relaxed">

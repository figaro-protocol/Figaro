    ...
    return (
        <>
            ...
            <section className="container mx-auto px-6 pb-24 max-w-3xl border-t border-default pt-12">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The second is the payment, which is now simply the kitchen&apos;s own. The deal ended the moment you confirmed, and nothing in it knows or cares what happens next. What happens next is that the kitchen spends what it was paid: one transaction, split among addresses it earmarked itself &mdash; a share set aside for tax, what it owes its supplier, what it puts by. No term of the dinner routed any of that; the split is the kitchen&apos;s own arithmetic over its own tokens, done afterwards, and the fiscal trail it leaves is a byproduct nobody had to assemble later. The courier does the same with their 2.10, or doesn&apos;t &mdash; nobody supervises either wallet but its own owner.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

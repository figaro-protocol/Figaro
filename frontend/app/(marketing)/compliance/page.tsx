        ...
        <>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <ul className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Terms</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Signatures</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Time</span>
                        <span>Block timestamps on finalized blocks. Set by consensus rules, not retroactively modifiable.</span>
                    </li>
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Bonds</span>
                        <span>Locked collateral visible on chain. Who posted what, when, in what currency.</span>
                    </li>
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Lifecycle</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Settlement</span>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="border border-gray-200 rounded-lg p-5">
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Class A — settlement byproduct</div>
                        ...
                        <p className="text-xs text-gray-500">Weight: high. The incentive structure guarantees emission.</p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-5">
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Class B — discretionary attestation</div>
                        <p className="text-sm text-gray-700 leading-relaxed mb-3">
                        ...
                        <p className="text-xs text-gray-500">Weight: conditional. Apply ordinary authentication-and-hearsay analysis. The record is tamper-proof once signed; accuracy at the moment of signing is the audit question.</p>
                    </div>
                </div>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">For an individual process</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">For a counterparty over time</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">For a claim about specific off-chain performance</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">For a dispute between parties</div>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Replaces</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Does not replace</div>
                        <ul className="space-y-2 text-sm text-gray-700 leading-relaxed">

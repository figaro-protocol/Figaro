    ...
    return (
        <PaperLayout slug="visibility-of-coordination"
            ...
            abstract={
                <>
                    ...
                    <p>
                        A recently developed settlement primitive &mdash; its mechanism formalized and its kernel verified, by machine checks its own authors ran and not yet by any external audit &mdash; makes the coordination function <em>visible</em> by separating it from the entities that currently perform it, and in doing so opens the organizational space to patterns of which the firm is only one. The primitive is not a better firm or a decentralized platform; it is an <em>organizational substrate</em> on which multiple coordination forms can be expressed. This paper is concerned not with the primitive itself but with what its existence reveals about the incumbent arrangement: how a contingent infrastructure passes for natural gravity, why challenging it differs from challenging an explicit ideology, and what communicative work is required to make existing architecture legible as architecture. The aim is diagnostic, not predictive: we do not argue that the primitive will displace incumbents, but that recognizing such displacement as conceivable is itself the political-economy problem.
                    </p>
                </>
            }
            references={
                <>
                    ...
                    <li>Edelman. <em>2025 Edelman Trust Barometer</em>. Annual cross-national survey on institutional trust, conducted yearly since 2001.</li>
        ...
        >
            <PaperSection title="1. Introduction">
                <p>
                    This paper sits between political economy and the philosophy of infrastructure. Its starting point is a recently developed settlement primitive that prices the cost of trust at a fixed multiple of transaction value, with no recurring extraction and no arbitrator. Its mechanism &mdash; asymmetric bonding plus buyer dominance with atomic resolution &mdash; yields the bonding equilibrium derived in <Link href="/papers/asymmetric-bonding" className="text-ink-heading hover:underline">Asymmetric Bonding and Buyer Dominance</Link>: cooperation weakly dominates defection for both parties, at every position of a multi-party process, on standing assumptions that are few and plain &mdash; the payoffs are the mechanism&rsquo;s own transfers and nothing else, resolution is terminal while withholding is not, the buyer&rsquo;s signature was given for this delivery, and monitoring is perfect. Its kernel, whose settlement properties its own authors have machine-checked and no outside auditor has yet examined, executes that equilibrium, and the institutional-economic consequence is a redrawn boundary of the firm. The present paper takes these results as given and asks a different question.
                </p>
                <p>
            ...
            <PaperSection title="3. The Coordination Function as Design Choice">
                ...
                <PaperSubsection title="3.1 Figaro as Organizational Substrate">
                    ...
                    <p>
                        The appropriate analogy is not between software tools but between energy substrates: one cannot simply engineer the outgoing paradigm&rsquo;s artifact on the new substrate and call it equivalent, the way an electric vehicle is not an internal-combustion car with batteries attached but a distinct design native to the new substrate. Legacy institutions that describe the bonded primitive in firm-vocabulary (&ldquo;decentralized firm,&rdquo; &ldquo;DAO as a new kind of corporation,&rdquo; &ldquo;network equivalent of a platform&rdquo;) are making the analogous mistake. The forms that will dominate the new substrate are not yet named, and the vocabulary for naming them is still being produced.
                    </p>

    ...
    return (
        <PaperLayout slug="visibility-of-coordination"
            ...
            abstract={
                <>
                    ...
                    <p>
                        We argue that the proposition &ldquo;two strangers need a platform to transact safely&rdquo; has achieved hegemonic status in the precise Gramscian sense: it is no longer argued for; it is presupposed in the language used to describe alternatives. The same applies to the propositions that production requires firms (the Coasean assumption) and that cross-border settlement requires state- or alliance-controlled rails. Each is a contingent design choice that has acquired the appearance of structural necessity.
                    </p>
                    <p>
                        A recently developed settlement primitive &mdash; its mechanism formalized and its kernel verified &mdash; makes the coordination function <em>visible</em> by separating it from the entities that currently perform it, and in doing so opens the organizational space to patterns of which the firm is only one. The primitive is not a better firm or a decentralized platform; it is an <em>organizational substrate</em> on which multiple coordination forms can be expressed. This paper is concerned not with the primitive itself but with what its existence reveals about the incumbent arrangement: how a contingent infrastructure passes for natural gravity, why challenging it differs from challenging an explicit ideology, and what communicative work is required to make existing architecture legible as architecture. The aim is diagnostic, not predictive: we do not argue that the primitive will displace incumbents, but that recognizing such displacement as conceivable is itself the political-economy problem.
                    </p>
                </>
            }
            references={
                <>
                    ...
                    <li>Genovese, F. R. &amp; Daliana, A. Figaro: A Proof-of-Delivery Blockchain Solution to the Last Mile Problem. Unpublished working paper, 2022.</li>
                    ...
                    <li>Scott, J. C. <em>Seeing Like a State: How Certain Schemes to Improve the Human Condition Have Failed</em>. Yale University Press, New Haven, CT, 1998.</li>
        ...
        >
            <PaperSection title="1. Introduction">
                <p>
                    This paper sits between political economy and the philosophy of infrastructure. Its starting point is a recently developed settlement primitive that prices the cost of trust at a fixed multiple of transaction value, with no recurring extraction and no arbitrator. Its mechanism &mdash; asymmetric bonding plus buyer dominance with atomic resolution &mdash; yields the bonding equilibrium; its verified kernel executes that equilibrium; and the institutional-economic consequence is a redrawn boundary of the firm. The present paper takes these results as given and asks a different question.
                </p>
                <p>
            ...
            <PaperSection title="2. Hegemony in the Gramscian Sense">
                ...
                <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li><strong>Cross-border settlement requires rails controlled by state or alliance actors.</strong> Payment rails, clearing networks, settlement systems, correspondent-banking relationships: the proposition that cross-border value transfer must clear through some sovereign or coalition is so embedded that the distinction between &ldquo;geopolitical competition for control&rdquo; and &ldquo;geopolitical contestation of necessity&rdquo; is rarely made. The corridor bundles more than settlement &mdash; ports, railways, and undersea cables are physical infrastructure a settlement primitive does not touch; the claim here concerns only the settlement and clearing layer of the bundle.</li>
                </ol>
                ...
                <PaperRun title="A permissive condition, not a signature.">
                    The configuration is not stable. The Edelman Trust Barometer (Edelman, 2026), conducted annually since 2001, has tracked steady cross-national decline in public trust of the institutions whose authority sustains the platform/firm/corridor arrangement: business, government, media, and NGOs. The decline is not bounded to any country or sector. We do not read it as a signature of hegemonic crisis &mdash; trust surveys measure many things, and the inference from falling trust to failing hegemony is not available at this level of evidence. We read it as a permissive condition: when the configuration can rely less on unexamined common sense, articulating its contingency becomes legible in ways it was not before. It does not by itself produce a counter-hegemonic formation.
                </PaperRun>
                <PaperRun title="Hegemonic convergence and Schelling convergence are different.">
                    The hegemonic convergence we describe is <em>presupposed</em> convergence &mdash; the arrangement is common sense because participants do not deliberate about it. <em>Schelling convergence</em>, in Schelling&rsquo;s (1960) sense, is <em>recognized</em> convergence &mdash; participants knowingly pick a focal point because they correctly expect others to, and the recognition is part of the coordination mechanism. The contemporary configuration operates in the first register; the cohort operating around the bonded primitive operates in the second. Counter-hegemonic coordination is necessarily a Schelling process &mdash; an arrangement cannot be presupposed while it is still being argued for &mdash; and the work of making it legible is, in part, the work of establishing it as a credible focal point around which aligned participants converge without central authority.
                </PaperRun>
            </PaperSection>

            <PaperSection title="3. The Coordination Function as Design Choice">
                <p>
                    The reading we propose is that the settlement primitive makes the coordination function visible by separating it from the entities that currently perform it. We offer this as an interpretive claim of the present paper, not as a theorem of the mechanism itself: the bonding game &mdash; composed of asymmetric bonding (Mechanism 1, which prices enforcement) and buyer dominance with atomic resolution (Mechanism 2, which propagates coordination through the bonded mesh) &mdash; establishes equilibrium properties, and the separation reading is the political-economy lens through which we propose those properties be understood. Under that lens, the platform&rsquo;s coordination function (matching, enforcement, dispute resolution) becomes an executable, ownerless mechanism. The firm&rsquo;s coordination function becomes Coase&rsquo;s (1937) three transaction costs &mdash; search, negotiation, enforcement &mdash; each priced rather than internalized. The corridor&rsquo;s settlement and clearing function &mdash; the one sliver of its coordination bundle a bilateral bonded mechanism can absorb &mdash; becomes a bonded commitment between the transacting parties; the corridor&rsquo;s physical layers are untouched. Crucially, the <em>multi-party coordination</em> function of these legacy entities &mdash; the work of holding <Math>{"N"}</Math> parties in synchronized commitment through to a single resolution &mdash; becomes the work of Mechanism 2 rather than of an organizational nucleus. What Mechanism 1 prices is settlement discipline under perfect monitoring with costless performance; an honest dispute over whether performance met the agreement is not priced away but relocated to the forums composed above the mesh.
                </p>
                <p>
                    The crucial move is not replacement but separation: once the coordination function is identified as a specific bundle of services that some technology provides &mdash; rather than as an undifferentiated property of the entity that currently provides it &mdash; the bundle becomes disaggregable, and disaggregation makes substitution conceivable.
                </p>
                <PaperSubsection title="3.1 Figaro as Organizational Substrate">
                    <p>
                        The reframing we propose is that the bonded settlement primitive is not a better firm, a better platform, or a better corridor. It is a <em>substrate</em>: an infrastructural layer on which multiple organizational forms can be expressed, only one of which is the firm. Holacracy, to pick one example, was a network-native coordination experiment confined to a single firm&rsquo;s ownership nucleus; the primitive generalizes network-native coordination <em>beyond</em> any particular nucleus, opening the organizational space to patterns the firm paradigm has no vocabulary for &mdash; standing treasury communities, transaction-scoped assemblies, agent coalitions, peer networks that cross institutional and jurisdictional lines. We take &ldquo;substrate&rdquo; as a working hypothesis; the formal question of which composed mechanisms preserve the bonding equilibrium is a matter for the mechanism proof, not for this essay.
                    </p>
                    <p>
                        The appropriate analogy is not between software tools but between energy substrates. The transition from coal to oil produced a new industrial landscape; the current transition to electric power produces another, and legacy manufacturers repeatedly demonstrate that one cannot simply engineer the outgoing paradigm&rsquo;s artifact on the new substrate and call it equivalent &mdash; an electric vehicle is not an internal-combustion car with batteries attached but a distinct design whose architecture, supply chain, and operational logic are native to the new substrate. Legacy institutions that describe the bonded primitive in firm-vocabulary (&ldquo;decentralized firm,&rdquo; &ldquo;DAO as a new kind of corporation,&rdquo; &ldquo;network equivalent of a platform&rdquo;) are doing what Western automakers did for the first two decades of the electric transition. The forms that will dominate the new substrate are not yet named, and the vocabulary for naming them is still being produced.
                    </p>
                    <PaperRun title="A note on the name.">
                        The protocol bears the name Figaro after the factotum of Seville: the coordinator who arranges, brokers, and mediates between parties of otherwise incommensurable standing without owning what is being coordinated. The naming is substantive, not decorative. A bonded settlement primitive that holds the bonds, executes commitments, and discharges resolution without occupying the position of counterparty or patron is a factotum in the literal sense: one that &ldquo;does everything&rdquo; while owning nothing. The visibility argument of this paper is, in part, an argument about naming: an institution whose coordination function lacks a vocabulary of its own remains structurally invisible <em>as</em> a coordination function. The naming dates to the project&rsquo;s first formulation (Genovese &amp; Daliana, 2022), predating the present mechanism by four years.
                    </PaperRun>
                    <PaperRemark title="On what &ldquo;visible&rdquo; means here.">
                        Gramsci&rsquo;s analysis emphasized the role of <em>intellectuals</em> &mdash; in his idiosyncratic sense &mdash; in producing the conceptual vocabulary through which arrangements become contestable. Making the coordination function visible is, in that register, a kind of intellectual labor. It is not technical exposition (technical readers already see it); it is the work of producing a vocabulary in which non-technical readers can see it without first becoming technical readers. The bonding equilibrium and the mechanism proof already exist; the present paper is the prerequisite for their being absorbable in venues where they otherwise sound like noise.
                    </PaperRemark>
                </PaperSubsection>
            </PaperSection>

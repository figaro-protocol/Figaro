        ...
        >
            ...
            <PaperSection title="4. The Agent Loop">
                ...
                <PaperRun title="The full loop.">
                    A operator &mdash; the reference participation agent &mdash; wires the four phases together with a polling interval, loading the wallet from configuration, selecting the policy from configuration (HITL by default), and running the loop until shutdown. The operator is not a production system; it is a fork-and-modify reference that any operational deployment specializes into its own runtime. Other runtimes are expected; the protocol is language-agnostic, and the only requirements are a wallet, EIP-712 signing, and event-derived state.
                </PaperRun>
            </PaperSection>

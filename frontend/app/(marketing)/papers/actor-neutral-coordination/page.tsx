    ...
    return (
        ...
        >
            ...
            <PaperSection title="2. The Settlement Primitive">
                <p>
                    The bonded primitive&rsquo;s mechanism-design derivation and its formal verification &mdash; the equilibrium and atomic-resolution properties are machine-checked against a model of the kernel&rsquo;s state transitions, by the authoring project itself and with no external audit performed to date &mdash; are out of scope for the present paper. The features the agent architecture relies on are the following.
                </p>

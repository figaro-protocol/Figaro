            ...
            <PaperSection title="4. Clause Design as a CS Discipline">
                ...
                <PaperSubsection title="4.1 The four-layer verification stack">
                    ...
                    <PaperRun title="Runtime-tier UI binding.">
                        A frontend integration that consumes the Layer A specification via <code>useClauseValidator(clauseId)</code>, renders clause-typed forms through the existing module and view system, and delivers the ABI-encoded content to the chain through the Layer C validator. The runtime tier is not strictly part of the verification stack, but it is part of the clause&rsquo;s deployment surface; an unintegrated clause exists on chain and not in any product.
                    </PaperRun>

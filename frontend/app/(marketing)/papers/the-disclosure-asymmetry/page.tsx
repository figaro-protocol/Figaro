    ...
    return (
        <PaperLayout slug="the-disclosure-asymmetry"
            ...
            abstract={
                <>
                    <p>
                        Mechanism design and the engineering of consent deploy the same instruments &mdash; incentives, common knowledge, equilibrium selection. The mid-century craft of consent-engineering (Lippmann, 1922; Bernays, 1928, 1947), its critical analysis (Herman &amp; Chomsky, 1988), and its industrial continuation in the surveillance economy (Zuboff, 2019) describe a technology for manufacturing a disposition in a population. The Nobel-recognized theory of mechanism design (Hurwicz, Maskin, Myerson) describes a technology for selecting an equilibrium among self-interested agents. They are usually treated as unrelated &mdash; one a dark art of persuasion, the other a formal economics. This paper argues they are the same instrument pointed in opposite directions, and isolates the operation that reverses the vector.
                    </p>
                    <p>
        ...
        >
            <PaperSection title="1. Premises">
                ...
                <PaperRun title="The manufacture is now an industry.">
                    Zuboff (2019) carries that lineage into the digital present and gives it an economics. Surveillance capitalism, on her account, &ldquo;unilaterally claims human experience as free raw material&rdquo; for translation into behavioral data; the surplus beyond what any service requires &mdash; her <em>behavioral surplus</em> &mdash; is refined into prediction products and sold in <em>behavioral futures markets</em>. The movement that matters here is the last one: the surest way to predict behavior is to intervene in it, so the apparatus turns to what she calls <em>economies of action</em> &mdash; tuning, herding, and conditioning at population scale, engineered to operate beneath the individual&rsquo;s awareness and around their decision rights. She names the result <em>instrumentarian power</em> and distinguishes it from totalitarian power: it does not demand belief, it instruments behavior toward ends the behaving party never chose. What her account adds to the premise above is that the dependence on the target&rsquo;s inaccuracy is constitutive rather than incidental, and now capitalized: the populations acted upon are, in her description, largely ignorant of the procedures and are given no meaningful mechanism of consent. Zuboff is careful that this cuts one way only &mdash; because the asymmetries of knowledge and power leave the individual little exit, her remedy is collective and legal rather than a better-informed user. We keep that caution: accuracy is what sets the sign, and commitment and neutral objectives are what hold it.
                </PaperRun>
            ...
            <PaperSection title="4. Figaro as the Worked Instance">
                ...
                <PaperRemark title="On scope.">
                    The worked instance is deliberately thin. Figaro&rsquo;s kernel is a small resolution primitive, not a general theory; how many orders a single process can atomically resolve is a mechanism-design question this paper leaves to that treatment, and the unbounded coordination the wider architecture supports comes from composing many such processes, not from stretching one. The claim here needs none of that scale &mdash; it needs only that the mechanism be disclosed, deterministic, decentralized, and permissionless, which the smallest bonded exchange between two parties already is.
                </PaperRemark>
            </PaperSection>

            <PaperSection title="5. Answering Viljoen, Goldenfein & McGuigan">
                <p>
                    Their diagnosis is correct for platforms and survives intact here; we do not need it to be wrong. We need only to locate the variable it holds fixed and show the cryptoeconomic setting moves it. The diagnosis turns on <em>opacity</em> &mdash; their word &mdash; and opacity is low accuracy with the gap held in the designer&rsquo;s favor. Negate it and the sign flips. Three flips, in increasing depth.
                </p>

        ...
        >
            ...
            <PaperSection title="4. Figaro as the Worked Instance">
                ...
                <PaperRemark title="On scope.">
                    The worked instance is deliberately thin. Figaro&rsquo;s kernel is a small settlement primitive, not a general theory; how many orders a single process can atomically resolve is a mechanism-design question this paper leaves to that treatment, and the unbounded coordination the wider architecture supports comes from composing many such processes, not from stretching one. The claim here needs none of that scale &mdash; it needs only that the mechanism be disclosed, deterministic, and ownerless, which the smallest bonded exchange between two parties already is.
                </PaperRemark>
            </PaperSection>

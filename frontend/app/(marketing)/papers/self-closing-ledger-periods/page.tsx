        ...
        >
            ...
            <PaperSection title="5. A Figaro Process as a Self-Closing Ledger Period">
                ...
                <PaperSubsection title="5.1 The contract state as a balance-sheet position">
                    ...
                    <p>
                        The buyers and sellers in this identity are wallets representing real-world assets, with the wallet, the asset, and the operator distinct in ways that matter when the identity is read at scale; Section 8 canonicalises that apparatus and shows how treasury operators compose it. The present section&rsquo;s identity holds independently of the wallet&rsquo;s institutional shape behind the address.
                    </p>
                </PaperSubsection>
                ...
                <PaperSubsection title="5.3 Supporting documentation and the complete record">
                    ...
                    <ul className="space-y-2 list-disc pl-6 text-sm">
                        ...
                        <li><em>Contemporaneous lifecycle evidence</em>: schema-typed attestations emitted during process life (proximity proofs, handoff attestations, quality disclosures, lifecycle-stage transitions). These are the analogue of working papers and supporting receipts in conventional accounting. Their class (settlement byproduct vs. discretionary attestation) matters for evidentiary weight; Section 9 treats this.</li>
                    </ul>
                    <p>
            ...
            <PaperSection title="8. Wallets, Real-World Assets, and Treasury Composition">
                ...
                <PaperRun title="Bookkeeping from chain state.">
                    Accounting tooling reads chain state directly. Every commit / resolution event pair is a complete disbursement record with full context: the parties, the amount, the schemaIds, the agreement-hash, the cumulative position. No reconciliation against a separate institutional ledger is required. The chain is the primary record from which the treasury&rsquo;s books for the disbursed-via-Figaro portion of its activity are derived, with the off-chain content addressed by the chain (agreement texts, attestations, schema-typed documents) carrying the substantive content the records refer to. This is the natural extension of the audit-against-reality function Section 7 discusses: the AU-C&nbsp;500 existence work remains, and the AU-C&nbsp;500 accuracy-of-recording work is discharged by the protocol.
                </PaperRun>
                <PaperRun title="Operational constraints these patterns inherit.">
                    The patterns inherit four constraints from the bonded primitive that an operator considering treasury composition needs to understand.
                </PaperRun>
                <p>
            ...
            <PaperSection title="9. Admissibility, Primacy, and the Two Classes of Record">
                ...
                <p>
                    <em>Settlement-byproduct records</em> are produced mechanically by the bonding game &mdash; commitment digests, bond deposits, the cumulative-value accumulator state, resolution events. They are emitted by the kernel itself, schema-typed at the kernel level, cryptographically authenticated, and self-verifying by construction. In the accounting register they are the primary ledger entries: journal and closing entries that no party can alter ex post.
                </p>
                <p>
                    <em>Discretionary attestation records</em> are produced voluntarily by self-interested parties &mdash; proximity proofs, handoff attestations, lifecycle-stage transitions, quality disclosures. These are evidentiary artifacts <em>about</em> the underlying settlement; they require schema validation but remain attestations, not byproducts. In the accounting register they are supporting documentation: working papers, evidentiary exhibits, operational attestations.
                </p>
                <p>

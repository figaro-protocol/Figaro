        ...
        <PaperLayout slug="self-closing-ledger-periods"
            ...
            references={
                <>
                    ...
                    <li>European Parliament and Council of the European Union. <em>Regulation (EU) No 910/2014 of 23 July 2014 on electronic identification and trust services for electronic transactions in the internal market (eIDAS)</em>. Official Journal of the European Union, 2014.</li>
                    ...
                    <li>National Conference of Commissioners on Uniform State Laws (NCCUSL). <em>Uniform Electronic Transactions Act</em>. Uniform Law Commission, 1999.</li>
                    ...
                    <li>United Nations Commission on International Trade Law. <em>UNCITRAL Model Law on Electronic Commerce</em>. United Nations, New York, 1996 (with additional article 5 bis adopted 1998).</li>
                    <li>United States. <em>Electronic Signatures in Global and National Commerce Act (E-SIGN)</em>. Pub. L. No. 106&ndash;229, 2000; codified at 15 U.S.C. &sect;&nbsp;7001 <em>et seq.</em></li>
        ...
        >
            ...
            <PaperSection title="6. What Continues">
                ...
                <PaperRun title="A receipt with no counterparty.">
                    One interpretive question the setting creates deserves naming, because it has no conventional analogue and the record cannot answer it. Alongside the payments a wallet earns under agreements it signed, a wallet may come to hold tokens that no counterparty owed it. A fixed schedule of the protocol&rsquo;s own token is set aside, period by period, for the authors of the composable terms and templates that settled processes actually used, and a wallet&rsquo;s share of a period is fixed on counted usage alone &mdash; on how many settled processes carried its work and, weighted more heavily, on how many distinct staked sellers did, below a floor of which the work scores nothing at all. The rule is uniform: no category, no weight, no per-recipient cap, so wider adoption divides each instalment among more recipients rather than enlarging it. Nothing is pushed to anyone; once a period has closed, an eligible author claims what that period&rsquo;s arithmetic already fixed, or does not. Such a receipt has no counterparty, no performance obligation behind it, and no agreement the recipient signed; it is not consideration in any contractual sense. Whether it is revenue, a capital contribution, a non-reciprocal receipt that triggers no recognition, or something else again, is interpretive work governed by the standards above and requiring judgment. The record establishes that the claim was made, by whom, and on what counted usage; it classifies nothing.
                </PaperRun>
            ...
            <PaperSection title="7. The Asset Behind the Wallet">
                ...
                <PaperRemark title="Why co-sellers share fate for the duration.">
                    The sustainability logic explains the interest that &sect;4.5 priced. Because the process settles as one, every seller&rsquo;s release waits on every other&rsquo;s performance, so for as long as a process stands open the assets behind those wallets share a fate: a co-seller&rsquo;s failure is not an isolated matter of one counterparty&rsquo;s conduct but a position the others go on standing in. That is why the remedies of &sect;4.5 are undertaken by parties who owe each other nothing &mdash; each is an asset whose own continued participation depends on receipts, and the closing act that releases all of them is the same act for all of them. The record supplies the interest and its magnitude; what any party does about it is conduct, which the record neither compels nor predicts.
                </PaperRemark>
            </PaperSection>

            <PaperSection title="8. Admissibility, Primacy, and the Two Classes of Record">
                <p>
                    The record produced by a bonded process is more than evidentiary about the process: it is constitutive of the process&rsquo;s accounts. The distinction matters in two registers.
                </p>
                <PaperRun title="Admissibility versus primacy.">
                    Electronic records of this kind are admissible under the electronic-signature and electronic-records regimes now in force in most commercial jurisdictions &mdash; the EU&rsquo;s eIDAS Regulation (European Parliament and Council, 2014), the Uniform Electronic Transactions Act and E-SIGN in the United States (NCCUSL, 1999; United States, 2000), the UNCITRAL Model Law on Electronic Commerce and its successors (UNCITRAL, 1996), and analogous instruments elsewhere. Admissibility asks whether a record may be introduced and weighed. Primacy asks whether it is <em>the</em> account of the activity or merely <em>an</em> account of it. For a bonded process the record is the primary account, and it is primary for a structural reason rather than an evidentiary one: no party wrote it, so there is no party whose competing account it would have to be weighed against. Documents a party holds about the process &mdash; a summary, a statement, an export &mdash; are derived from it and are summaries or translations of it, not rival records. This is a statement about the process, and it says nothing about the standing of the parties&rsquo; own entity-level accounts, which remain what they have always been.
                </PaperRun>
                <PaperRun title="Two classes of record.">
                    Within the process file the material divides into two classes carrying different evidentiary weight, and the division is the one Section 4.3 already drew between the entries and the supporting file.
                </PaperRun>
                <p>
                    <em>Settlement-byproduct records</em> are produced mechanically by the operation of the mechanism &mdash; the commitment digests, the bonds, the accumulator&rsquo;s state, the resolution. They are emitted by the settlement layer, authenticated by signatures the mechanism verified before acting on them, and self-verifying by construction: they are what the mechanism did, and it could not have done otherwise. In the accounting register they are the primary entries of &sect;4.2, which no party can alter afterwards because no party wrote them.
                </p>
                <p>
                    <em>Discretionary attestation records</em> are produced voluntarily by interested parties &mdash; handoffs, conditions, stage transitions, quality disclosures. Each is bound by inclusion to the agreement its commitment hashed, so it cannot be smuggled in against terms nobody agreed to; but the decision to make it, and the truth of what it asserts about the world, are the attesting party&rsquo;s. In the accounting register they are supporting documentation: working papers, exhibits, operational attestations.
                </p>
                <p>
                    Both classes belong to the complete file, and the distinction tells an auditor where to spend the budget. The byproduct class needs no verification against anything, being what the mechanism did. The discretionary class is exactly where the records-to-reality assertions of Section 6 bite, since it is the class that makes claims about a world the mechanism cannot see.
                </p>
            </PaperSection>

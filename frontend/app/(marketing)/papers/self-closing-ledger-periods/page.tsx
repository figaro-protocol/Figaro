    ...
    return (
        ...
        >
            ...
            <PaperSection title="8. Wallets, Real-World Assets, and Treasury Composition">
                ...
                <PaperRun title="Where the record comes to rest.">
                    Read across the whole market rather than one wallet at a time, this same condition is where the accounting picture comes to rest: the going-concern test, applied asset by asset, resolves not to any particular distribution of value capture but to each participating asset drawing, over time, the receipts it needs to remain a going concern. The record the chain keeps is accordingly the record of a productive life &mdash; the span over which an asset&rsquo;s on-chain receipts continue to cover its off-chain cost of remaining in service, and at the close of which the seller stops bonding the wallet in and its ledger period closes for the last time. What an auditor reads at the level of the market is therefore not a fixed allocation but this same judgment holding, wallet by wallet, wherever an asset still participates.
                </PaperRun>

        ...
        >
            ...
            <PaperSection title="4. A Bonded Process as a Self-Closing Ledger Period">
                ...
                <PaperSubsection title="4.5 Remedies inside the open period">
                    ...
                    <PaperRemark title="Why co-sellers take an interest.">
                        Atomic resolution gives every seller in a process a computable interest in every other&rsquo;s performance: since the process resolves as one, a seller that has already performed stands in its whole bond for as long as any order remains unperformed, and the magnitude of that exposure is readable from the record. This is a weakest-link structure in the sense of Hirshleifer (1983) &mdash; the outcome for the group turns on the least contribution &mdash; and it is what makes remedy conduct among sellers rational rather than altruistic. What follows from it is the interest and its size; what any seller does about it is conduct, not a consequence, and this paper derives no behaviour from the figure. For the accountant the relevant point is narrower and firmer: the transfers such conduct produces are dated inside the open period, so they enter the same period as the resolution they precede, and no subsequent-events treatment or prior-period adjustment ever arises.
                    </PaperRemark>
                </PaperSubsection>
            </PaperSection>
            ...
            <PaperSection title="6. What Continues">
                ...
                <ul className="space-y-2 list-disc pl-6 text-sm">
                    ...
                    <li><em>Valuation and allocation</em> remains interpretive: fair value, impairment, amortisation, and similar measurement decisions are not what a process&rsquo;s data contains.</li>
            ...
            <PaperSection title="10. Conclusion">
                ...
                <PaperRun title="The third inflection.">
                    Pacioli made the position of an entity legible. Nakamoto (2008) and Buterin (2014) made settlement itself a shared record rather than an intermediary&rsquo;s book. The kernel makes the record process-scoped and self-closing, which returns the accounting entity to the size of a transaction &mdash; the size it had before firms were invented to hold coordination durably. Each inflection reduces a specific apparatus from necessary to optional for the class of activity it covers, and leaves the rest intact. This paper is an attempt to describe what the third entails before the debate is muddied by the usual overpromising of blockchain-accounting claims and the usual under-appreciation of what specifically has changed.
                </PaperRun>

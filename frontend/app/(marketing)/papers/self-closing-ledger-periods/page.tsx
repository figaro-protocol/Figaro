        ...
        >
            <PaperSection title="1. Introduction">
                ...
                <PaperRun title="Paper organization.">
                    Section 2 describes the Pacioli stack &mdash; double-entry, the apparatus on top, its place within the longer banking arc, and the costs and benefits of the arrangement. Section 3 treats the prior literature on triple-entry bookkeeping and blockchain-accounting, acknowledging the antecedents we depart from. Section 4 develops the central technical claim: a Figaro process is a self-closing ledger period. Section 5 describes what stops being necessary. Section 6 describes what continues and why. Section 7 treats admissibility, primacy, and the two classes of record. Section 8 states the argument&rsquo;s limits. Section 9 concludes.
                </PaperRun>
            </PaperSection>
            ...
            <PaperSection title="3. Triple-Entry and Its Limits">
                ...
                <p>
                    A more deeply formal antecedent is Mattessich (1964), who develops accounting as an axiomatic system: the double-entry identity is an algebraic invariant on a set of basic propositions about value flows, analogous to the conservation laws of physics. The custodial identity we will define in Section 4 below is, in Mattessich&rsquo;s sense, the same algebraic invariant restated for the bonded process: total assets in the contract&rsquo;s escrow equal total liabilities to the bonded parties at every moment of the process&rsquo;s life, with the equality discharged at settlement.
                </p>
                <p>
            ...
            <PaperSection title="4. A Figaro Process as a Self-Closing Ledger Period">
                <p>
                ...
                <PaperSubsection title="4.3 Supporting documentation and the complete record">
                    ...
                    <ul className="space-y-2 list-disc pl-6 text-sm">
                        ...
                        <li><em>Contemporaneous lifecycle evidence</em>: clause-typed attestations emitted during process life (proximity proofs, handoff attestations, quality disclosures, lifecycle-stage transitions). These are the analogue of working papers and supporting receipts in conventional accounting. Their class (settlement byproduct vs. discretionary attestation) matters for evidentiary weight; Section 7 treats this.</li>
                    </ul>
                    <p>
            ...
            <PaperSection title="5. What Stops Being Necessary">
                <p>
            ...
            <PaperSection title="7. Admissibility, Primacy, and the Two Classes of Record">
                <p>
                ...
                <p>
                    Both classes are part of the complete accounting record. An audit that tests the records against real-world performance (Section 6 above) is primarily an audit of the discretionary class, since the byproduct class is self-verifying by construction.
                </p>
            </PaperSection>

            <PaperSection title="8. Scope and Limitations">
                <p>
                    The paper&rsquo;s argument is bounded in two ways that we state explicitly to preempt predictable misreadings.
                </p>

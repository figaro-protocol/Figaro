        ...
        >
            ...
            <PaperSection title="4. The Wallet as Legal Subject">
                ...
                <ol className="list-[lower-alpha] pl-6 space-y-3">
                    ...
                    <li><strong>Credentialing is self-attached.</strong> At the protocol tier, schema-validated attestations and operator profiles attach to the wallet; at the runtime tier, NFT-anchored deeds and credentials may be layered on. A worker&rsquo;s skills, certifications, and performance history travel with the wallet, not with the employer. The resume becomes the wallet; the reference becomes an attestation.</li>
                </ol>

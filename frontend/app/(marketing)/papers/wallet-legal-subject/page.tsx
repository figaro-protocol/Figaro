        ...
        >
            ...
            <PaperSection title="2. Subordination as the Labor-Law Variable">
                ...
                <PaperSubsection title="2.2 The Philosophical Position">
                    ...
                    <p>
                        The structural observation common to Ellerman and Anderson &mdash; that the employment relation places one party&rsquo;s conduct under another party&rsquo;s authority along an axis whose endpoints touch historical arrangements of chattel and serfdom &mdash; has currency outside academic labor philosophy as well (Taleb (2018), in &ldquo;How to Legally Own Another Person,&rdquo; puts it bluntly: &ldquo;an employee is practically a slave&rdquo;). The observation, however framed, is that the axis is subordination; the differences between historical arrangements at different points on it are quantitative.
                    </p>
            ...
            <PaperSection title="5. The Gig-Economy Cases, Re-read">
                <p>
                    The gig-economy case law can be read as a series of attempts to place the employee&ndash;contractor threshold in the face of a technology (the platform) that had engineered a new position on the subordination continuum. Re-read through the primitive&rsquo;s lens, four landmark measures share a fate: each one&rsquo;s operative test loses its subject.
                </p>
                <ul className="list-disc pl-6 space-y-2">
                    <li><strong>California AB5 (2019)</strong>, codifying the ABC test from <em>Dynamex Operations West v Superior Court</em> (2018): none of the three prongs is well-posed. There is no hiring entity to direct and control (prong A has no subject), no usual course of business for the bonded counterparty relation (prong B presupposes a firm), and the bonded party is by construction independently established (prong C is satisfied by default).</li>
                    ...
                    <li><strong><em>Uber BV v Aslam</em> (UKSC 2021)</strong>: the substance-over-label examination that classified drivers as <em>workers</em> has no entity whose substance can be examined, because the primitive produces no contract between a substance-behind-label and a worker. The rating-and-algorithmic-direction apparatus the judgment turned on is a platform artifact; it does not exist in the primitive.</li>
                    <li><strong>EU Platform Work Directive (2024)</strong>, the most sophisticated of the four, with a presumption of employment rather than a bright-line test: the presumption criteria (algorithmic management, supervision of work, restrictions on working for others) have no referent &mdash; there is no platform between the parties whose algorithmic management would trigger the presumption.</li>
                </ul>
                ...
                <PaperRun title="The endogenous-platform-emergence concern.">
                    A related concern is that platforms are likely to re-emerge on top of the bonded primitive. Even with the settlement core non-discretionary, surrounding layers &mdash; discoverability, dispatch, reputation aggregation, credit provision, identity vouching, key custody &mdash; will be supplied by some entity. That entity, once it reaches scale, will recreate the platform&rsquo;s economic position relative to the bonded counterparties on its layer. The substance-over-form doctrines will then have purchase against <em>that</em> entity exactly as they have purchase against existing platforms. We accept this concern without qualification. The primitive does not preclude platform-shaped intermediation in the layers built on top of it; it precludes it at the settlement layer itself. The settlement layer is the layer at which the direction-and-control finding has no subject; surrounding layers that introduce direction-and-control into the working relationship remain fully subject to the doctrinal test. The architectural claim is not that subordination is impossible on top of a bonded substrate; it is that subordination is no longer architecturally required, and where it appears it appears as a choice made in a surrounding layer that the existing labor-law apparatus is well-equipped to evaluate.
                </PaperRun>
            </PaperSection>
            ...
            <PaperSection title="7. Conclusion">
                ...
                <PaperRun title="A closing caveat.">
                    This paper&rsquo;s argument is diagnostic, not normative. It does not argue that the primitive will diffuse uniformly, that employment as a legal category will disappear, or that the change it describes is desirable in whole or in part. The vocabulary of &ldquo;subordination&rdquo; and &ldquo;slavery,&rdquo; borrowed from Anderson and Ellerman, is structural rather than moral: modern labor law has developed substantial protections that distinguish the employee from the serf and the serf from the slave, and the primitive removes the arrangement, not the moral progress the arrangement&rsquo;s softening represented. Whether the removal is desirable is a policy question; whether it is happening is an engineering one; the two should not be conflated. Legal scholarship will be better served by engaging the primitive on its own terms than by treating it as one more gig-economy platform to be reclassified under the existing test.
                </PaperRun>
            </PaperSection>
        </PaperLayout>
    );

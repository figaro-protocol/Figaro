        ...
        >
            ...
            <PaperSection title="4. The Wallet as Legal Subject">
                ...
                <ol className="list-[lower-alpha] pl-6 space-y-3">
                    ...
                    <li><strong>Credentialing is self-attached.</strong> Attestations and profile records attach to the wallet itself, and richer deeds and credentials can be layered on top. A worker&rsquo;s skills, certifications, and performance history travel with the wallet, not with the employer. The resume becomes the wallet; the reference becomes an attestation.</li>
                </ol>

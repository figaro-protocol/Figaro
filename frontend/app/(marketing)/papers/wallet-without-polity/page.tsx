        ...
        <PaperLayout
            ...
            abstract={
                <>
                    ...
                    <p>
                        The wallet-as-legal-subject argument extends here in a different direction. In the labor setting the wallet collapses the Roman <em>res</em>/<em>persona</em> distinction so that the productive asset is simultaneously property and party; in the present setting it allows the productive asset to act as party where civil-legal subjecthood is itself absent. We do not claim that the primitive resolves statelessness. Arendt (1951) named the right to have rights as the fundamental human right &mdash; a right whose denial is a civilizational failure rather than an individual misfortune &mdash; and the technological infrastructure considered here cannot grant it. What it grants is narrower: a capacity to have commerce, where the capacity to have rights is denied. The two should not be confused. For populations for whom the first is denied, the second is non-trivial.
                    </p>
                    <p>
                        The argument is positional rather than programmatic. Real constraints &mdash; key custody, counterparty willingness, fiat on-ramp, collateral access &mdash; are named and not dismissed. The analytical claim is that the primitive moves the humanitarian-economics gap from an architectural impossibility to an operational engineering question, and that this is a consequential move worth scholarship.
                    </p>
                </>
            }
            references={
        ...
        >
            <PaperSection title="1. Introduction">
                ...
                <PaperRun title="Paper organization.">
                    Section 2 summarizes the settlement primitive in the terms relevant here. Section 3 restates the wallet-as-legal-subject argument in the form needed for the present paper. Section 4 develops self-sovereignty as the cryptographic precondition. Section 5 develops the central claim across four moves: scale of the affected population, the architecture they face, what the primitive does and does not do, and the Arendtian distinction between the right to have rights and the capacity to have commerce. Section 6 names the operational constraints the primitive does not dissolve. Section 7 concludes.
                </PaperRun>
            </PaperSection>

            <PaperSection title="2. The Settlement Primitive">
                <p>
                    We summarize only the features relevant to the present argument; the mechanism, the Solidity implementation, and its formal verification are developed in their own right.
                </p>
                <p>
            ...
            <PaperSection title="3. The Wallet as Legal Subject (Brief)">
                <p>
                    Roman private law distinguished <em>res</em> (things, property, objects that can be owned and alienated) from <em>persona</em> (persons, parties, subjects capable of acting legally). The distinction survived and structures modern private law. The bonded primitive collapses the <em>persona</em>/<em>res</em> partition: a wallet is simultaneously a property (a key-pair owned and transferable) and a party (a signer, bonder, settlement-receiver). The collapse is operational rather than metaphorical; it follows from the architecture of dual-signed bonded commitments.
                </p>
                <p>
                    For the present paper the relevant consequence is narrower than the labor-law one but harder. In the labor setting the <em>persona</em>/<em>res</em> collapse dissolves the subordination gradient between employer and employee, because each party signs for itself and bonds for its own performance. In the present setting &mdash; where one or both parties may lack stable <em>persona</em> status in the host jurisdiction at all &mdash; the collapse means something stronger: the wallet provides a party-to-the-transaction whose existence does not depend on the prior existence of a recognized civil subject. The labor-law argument shows that the wallet can be both property and party. The argument here is that the wallet can be a party where no civil-legal party exists.
                </p>
                <p>
            ...
            <PaperSection title="4. Self-Sovereignty: The Cryptographic Key as Precondition">
                ...
                <PaperRun title="Three acts, three preconditions discharged.">
                    A bonded transaction reduces to three acts at the participant&rsquo;s side, and each has historically required a civil-legal precondition the bonded primitive replaces with a cryptographic one. <em>Signing:</em> the act of binding oneself to terms has required a recognized capacity to enter contracts (adulthood, sound mind, jurisdictional standing); under the primitive the capacity to sign is the capacity to control a private key, and EIP-712 signatures verify against the address that signed without consulting any registry of recognized subjects. <em>Bonding:</em> pledging assurance has required a counterparty willing to extend credit, a court willing to enforce a guarantee, or a recognized residency status enabling a banking relationship; under the primitive it is the act of locking collateral in a permissionless token, the return on cooperation enforced by the kernel, not a court. <em>Settling:</em> receiving consideration has required a banking relationship that can credit the receiving party in the receiving jurisdiction&rsquo;s currency; under the primitive settlement is direct wallet-to-wallet on resolution. The architectural property is unconditional; the operational property in any given denomination is not, since the bond-denomination currency is itself a jurisdictional artifact (USDC is freezable by Circle on Treasury request; ETH is acquired through KYC-gated exchanges) &mdash; the constraint developed in Section 6 below.
                </PaperRun>
                <p>
                    The three preconditions historically required &mdash; recognized capacity, intermediated assurance, banked settlement &mdash; are each replaced by cryptographic substitutes that do not require recognition by the civil-legal order. This is what self-sovereignty in our usage means: the agent&rsquo;s commercial agency is constituted by what the agent can prove cryptographically rather than by what the agent has been recognized as politically.
                </p>
                <PaperRun title="What self-sovereignty does and does not mean.">
                    The <em>self-sovereign-identity</em> (SSI) literature (Allen, 2016; Tobin &amp; Reed, 2017) is grounded in identity specifically: the participant holds verifiable credentials about themselves rather than depending on identity providers. Allen (2016) articulates ten principles for SSI &mdash; existence, control, access, transparency, persistence, portability, interoperability, consent, minimization, and protection &mdash; several of which extend beyond credential-holding into the agency-of-interaction register. The &ldquo;operational self-sovereignty&rdquo; sense we develop is the commerce-specific narrowing of Allen&rsquo;s broader agency principles, applied to the bonding, signing, and settling acts of bilateral commerce rather than to identity per se. The W3C Decentralized Identifiers specification (2022) formalizes the architectural shape: identifiers controlled by the subject through cryptographic keys, with no central registrar. SSI in the W3C-DID register is about <em>identity</em>, and the bonded primitive does not implement identity (the kernel knows wallets, not persons; identity is a runtime-tier concern). The <em>libertarian / Lockean</em> sense of sovereignty (Nozick, 1974; Locke, 1689) is normative: the agent has natural rights of self-ownership that political arrangements must respect. The bonded primitive is silent on natural rights; it provides architecture, not ethics. The sense we adopt is narrower than either: an agent whose commercial agency is operationally constituted by cryptographic self-control rather than by polity recognition &mdash; a structural fact about how the primitive operates, not a normative claim about how it should.
                </PaperRun>
                <PaperRun title="Why this matters specifically for the displaced.">
                    The general operational sense of self-sovereignty applies universally: any wallet that signs-bonds-settles is exercising this agency. But the marginal value of the architecture is asymmetric. A participant whose civil-legal subjecthood is already conferred and stable has plenty of paths to express commercial agency; the primitive is one substrate among many. A participant whose civil-legal subjecthood is denied or unstable does not have those paths. For them, the operational self-sovereignty the primitive supplies <em>is</em> the agency, not an augmentation to it. The Arendtian distinction &mdash; right to have rights versus capacity to have commerce &mdash; decomposes once self-sovereignty is named explicitly. The right to have rights is conferred by a polity recognizing the agent; self-sovereignty is constituted by the agent&rsquo;s cryptographic control of their own commercial agency. Conflating the two has been a recurring error in both directions: those who claim cryptographic infrastructure restores Arendtian rights overstate; those who claim it cannot do meaningful work for the displaced because it does not restore Arendtian rights also overstate. Self-sovereignty is real, modest, and operationally load-bearing where conventional infrastructure fails; it is not a substitute for political belonging where conventional infrastructure succeeds.
                </PaperRun>
                <PaperRun title="Key custody as the load-bearing operational variable.">
                    Self-sovereignty&rsquo;s architectural cleanness should not obscure its operational fragility. The architecture turns on the participant&rsquo;s ability to hold and use a private key reliably. For the displaced and stateless populations of greatest interest here, key custody is exactly where the architecture meets the hardest constraints: unstable access to power and connectivity, devices vulnerable to seizure or loss, environments where social-recovery networks are themselves disrupted by the displacement. The self-sovereign-identity community has invested significant effort in mitigations &mdash; social-recovery wallets where participant-trusted contacts can collectively recover a lost key (Buterin, 2021; Argent; Safe), secure elements in inexpensive hardware, mnemonic backup standards, biometric-binding schemes. None is perfect; each is an engineering artifact with its own threat model. Self-sovereignty without durable key custody is structurally incomplete, and the engineering of durable key custody for displaced populations is the work that translates architectural availability into deliverable agency.
                </PaperRun>
            </PaperSection>

            <PaperSection title="5. The Capacity to Have Commerce">
                <PaperSubsection title="5.1 Scale">
                    <p>
                ...
                <PaperSubsection title="5.2 The Received Architecture">
                    <p>
                ...
                <PaperSubsection title="5.3 What the Primitive Does and Does Not Do">
                    <p>
                        The primitive does not resolve statelessness. It does not confer citizenship, restore legal recognition, or create enforcement against a state that denies the person&rsquo;s standing. It is not a substitute for the political work that addresses those gaps. What it does is structurally narrower:
                    </p>
                ...
                <PaperSubsection title="5.4 Arendt and the Right to Have Rights">
                    <p>
                    ...
                    <p>
                        We take the objection seriously and decline it on these terms. The capacity-to-have-commerce we describe is not a substitute for membership; it is a structural precondition that membership historically subsumed and that, where membership is denied, can be supplied separately. The bonded transaction does include a recognition function in Arendt&rsquo;s sense, on a small scale: the commitment is dual-signed, the performance is attested, the record is public, and the counterparty acknowledges the participant as a party with whom binding agreements can be made. This is not the political recognition Arendt regarded as fundamental &mdash; co-membership in a polity &mdash; but it is not nothing in her register either. The accumulated record of such recognitions across many bonded relationships does not constitute a polity, but it does constitute a public visibility of the participant&rsquo;s actions that statelessness conventionally denies. The substrate supplies a portable evidentiary subjecthood that is not coextensive with political membership but that fills a gap statelessness has historically left empty.
                    </p>
                    <p>
                        The bonded primitive does not grant the right to have rights; it grants, more narrowly, a capacity to have commerce. The right to have rights is political and is not within the gift of any technology. The capacity to have commerce is structural and becomes operational once the cryptographic infrastructure is in reach. For populations for whom the first right is denied, the second capacity is non-trivial; for populations for whom the first right is granted, the second is largely subsumed by existing institutions. The primitive&rsquo;s leverage is asymmetric: where the conventional infrastructure works, it adds modestly; where it fails, it adds the architectural condition for participation at all.
                    </p>
                    <PaperRun title="The protection-gap residue the substrate cannot reach.">
                        The 1951 Refugee Convention and its 1967 Protocol enumerate rights the host state owes refugees within its territory: <em>non-refoulement</em> (Article 33), access to courts (Article 16), identity papers (Article 27), travel documents (Article 28), employment, public education, and public relief (Refugee Convention, 1951; Goodwin-Gill &amp; McAdam, 2021). The right to have rights as Arendt names it is closer to the spirit of the Convention than to any single article; the Convention operationalizes the spirit through specific institutional duties (Kesby, 2012; Benhabib, 2004). The bonded primitive supplies none of these: it cannot prevent <em>refoulement</em> (a sovereign decision on territorial admission); it cannot grant access to courts (a jurisdictional decision); it cannot issue identity papers, travel documents, or work permits. The protection gap Goodwin-Gill &amp; McAdam describe is real, vast, and political; the substrate addresses one of its many components (the inability to bind in commerce without a recognized counterparty) and leaves the others where they were. The position we hope to occupy is closer to Benhabib&rsquo;s: the rights-of-others framework identifies layers of moral and legal claim that are differently secured by different institutional arrangements, and the bonded substrate adds one such layer (commerce-binding capacity) without displacing the others.
                    </PaperRun>
                </PaperSubsection>
            </PaperSection>
            ...
            <PaperSection title="6. Operational Constraints">
                <p>
                    The present paper is positional rather than programmatic. The primitive moves the commerce-access gap from architectural impossibility to operational engineering question; it does not solve the engineering question. We name the constraints that remain.
                </p>
                <PaperRun title="Key custody.">
                    Populations with unreliable access to power, devices, and connectivity face usability barriers at the cryptographic layer the primitive does not solve. Loss-of-key risk is high in unstable environments, and key-recovery infrastructure for displaced populations is not built. Solutions exist (social recovery, custodial wallets with revocable trust) but each carries trade-offs the population is poorly positioned to evaluate.
                </PaperRun>
                <PaperRun title="Counterparty willingness.">
                    A well-resourced buyer in a recognized jurisdiction may decline to bond with a counterparty whose civil-legal standing is contested &mdash; not because of the primitive, but because of downstream legal exposure in the buyer&rsquo;s home jurisdiction (sanctions screening, anti-money-laundering obligations, forum-of-enforcement concerns). The primitive does not dissolve this friction. Its effect, where it has one, is to shift the friction from architectural (&ldquo;commerce with the displaced is impossible&rdquo;) to discretionary (&ldquo;some counterparties will, others will not&rdquo;).
                </PaperRun>
                <PaperRun title="Fiat on-ramp.">
                    Converting wallet-denominated value to local currency still runs through existing rails, which remain gated for the population in question. The primitive operates within the crypto-native settlement layer; the bridge to local purchasing power remains a separate problem with its own gatekeepers. Stablecoin acceptance by local merchants partially closes this gap; full closure depends on infrastructure outside the primitive.
                </PaperRun>
                <PaperRun title="Collateral access.">
                    Bonding requires collateral. A counterparty without starting capital cannot bond. This is a hard constraint on the primitive&rsquo;s applicability to populations whose displacement is correlated with asset loss. Mitigations exist at the assembly tier &mdash; sponsor pools, cooperative bonding, assembly-aggregated bonds, microfinance-style group guarantees &mdash; but each is a construction on top of the primitive, not a property of it, and none are yet built at scale. The primitive&rsquo;s equilibrium results assume both parties are legally and materially free to enter the bonding game and that capital sufficient to post the bond is available; for displaced populations whose displacement is itself the loss of capital, the second clause fails. Among the constraints listed, this is the one most likely to determine whether the primitive&rsquo;s contribution is real or merely technical.
                </PaperRun>
                <PaperRun title="Bond-currency jurisdictional embedding.">
                    The bond&rsquo;s denomination currency is itself a jurisdictional artifact. The primitive is denomination-agnostic, but the denominations available in practice are not. The principal US-dollar-pegged stablecoin (USDC) is issued by Circle, a US entity subject to OFAC enforcement and capable of freezing addresses on Treasury request; the Tornado Cash sanctions of August 2022, which targeted a piece of immutable open-source code rather than an entity, made explicit how far the regulatory reach can extend (OFAC, 2022; Van Valkenburgh, 2022). ETH is a neutral substrate at the protocol level but is acquired through exchanges that KYC. We recommend, where the architecture admits it, denominations whose issuance and transfer are not subject to discretionary freeze authority and whose acquisition does not run through KYC-gated exchanges; the selection criterion is structural rather than ideological. The cumulative effect of these constraints is that the primitive is not a solved-problem deliverable for displaced populations today; its present-tense contribution is architectural &mdash; commerce-without-recognition is now possible to build, where it was not before, and the constraints that remain are engineering problems with engineering solutions rather than structural features of the legal infrastructure.
                </PaperRun>
                <PaperRun title="Prior art the paper should engage.">
                    These constraints are not theoretical: they have been surfaced and partially addressed by humanitarian programs piloting blockchain-based assistance over the past decade. The World Food Programme&rsquo;s <em>Building Blocks</em> program (with UNHCR providing biometric registration), deployed in Jordan since 2017 and expanded across several refugee operations, uses on-chain transaction records to coordinate cash assistance from multiple agencies to the same beneficiaries while reducing duplicate disbursement and intermediary cost (WFP Building Blocks; Coppi &amp; Fast, 2019). Independent evaluations (Coppi &amp; Fast, 2019; Hernandez, 2017) are mixed: the programs achieve real operational improvements in coordination and disbursement, but the binding constraint identified across evaluations is not architectural recognition of the participant on chain &mdash; which the architecture supplies straightforwardly &mdash; but the host-state and on-ramp gatekeeping listed above. The displaced beneficiaries in these programs do not bond; they receive. The bonded primitive extends the architecture to a use case the existing programs have not yet exercised at scale: the displaced participant as <em>counterparty</em> in a productive bilateral exchange rather than as recipient of one-sided disbursement.
                </PaperRun>
            </PaperSection>

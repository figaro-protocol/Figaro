        ...
        >
            ...
            <PaperSection title="6. Operational Constraints">
                ...
                <PaperRun title="Collateral access.">
                    Bonding requires collateral. A counterparty without starting capital cannot bond. This is a hard constraint on the primitive&rsquo;s applicability to populations whose displacement is correlated with asset loss. Mitigations exist at the assembly tier &mdash; sponsor pools, cooperative bonding, assembly-aggregated bonds, microfinance-style group guarantees &mdash; but each is a construction on top of the primitive, not a property of it, and none are yet built at scale. The primitive&rsquo;s equilibrium results assume only agency and a stake &mdash; that each party can choose its own actions and has capital sufficient to post the bond. They are jurisdiction-invariant: they invoke no legal freedom, status, or standing, only the ability to sign and to bond. The one constraint that bites for the present analysis is therefore the material one &mdash; for displaced populations whose displacement is itself the loss of capital, the stake is simply unavailable. Among the constraints listed, this is the one most likely to determine whether the primitive&rsquo;s contribution is real or merely technical.
                </PaperRun>
                ...
                <PaperRun title="Prior art: humanitarian blockchain pilots.">

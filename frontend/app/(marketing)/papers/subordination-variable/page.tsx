    ...
    return (
        ...
        >
            ...
            <PaperSection title="6. What This Paper Is Not">
                ...
                <PaperRun title="Not an endorsement of either tradition.">
                    The associated-producer and frictionless-market readings are offered as descriptions of how a reader in each tradition can accurately characterize the primitive &mdash; not as the protocol&rsquo;s commitment or the author&rsquo;s normative endorsement. Marx&rsquo;s program included claims about distribution, the state, class struggle, and historical materialism on which the substrate takes no position; the classical-liberal tradition includes claims about the minimal state, property rights as foundational, and the moral status of distributional outcomes on which the substrate is equally silent. A reader who concludes from Section 4 that the protocol is Marxist, or that it is libertarian, has read description as endorsement.
                </PaperRun>
                <PaperRun title="Not synthesis, not post-political, not a prediction.">
                    The paper does not propose that the two traditions agreed all along or that the primitive is some dialectical resolution: the disagreement was real on its own terms, and the residual disagreements (Section 5) remain real after the substrate change. Nor does it claim that political economy is over &mdash; quite the opposite: the substrate&rsquo;s neutrality is the precondition under which the political-economic questions become legible as graph-level questions rather than substrate-level inevitabilities. And it does not predict that either tradition will recognize the substrate as the realization of its program; the argument is conceptual &mdash; under the supposition that the primitive is widely adopted, the substrate-level disagreement disentangles in the manner described. Whether adoption occurs is an empirical question, not the conceptual one this paper addresses.
                </PaperRun>
            </PaperSection>

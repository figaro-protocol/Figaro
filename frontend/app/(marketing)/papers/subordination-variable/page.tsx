        ...
        >
            ...
            <PaperSection title="5. Where the Partition Relocates">
                ...
                <PaperRun title="The social composition of assemblies.">
                    The substrate is permissive about who participates. It does not require a worker, an owner, an artificial intelligence, a state agency, a cooperative, or a foundation to participate or abstain; any wallet may compose with any other. What social composition produces a desirable political economy &mdash; whether assemblies should privilege workers, displace platform operators, exclude predatory actors, admit AI agents on equal footing, route around state authority, or none of these &mdash; is again a graph-level question. The substrate admits answers across the spectrum.
                </PaperRun>

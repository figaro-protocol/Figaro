        ...
        >
            ...
            <PaperSection title="6. Where Governance Returns: At the Graph">
                ...
                <PaperRun title="Assemblies as governed entities.">
                    A bonded multi-party process composed at the substrate is an assembly &mdash; a transaction-scoped arrangement of bonded commitments among multiple parties. A simple assembly (two parties, one commitment) requires no governance: the parties agreed, and the substrate enforces. A complex assembly typically does: questions arise the original commitments did not specify, parties join and leave, disputes require resolution beyond what bonding provides. For complex assemblies, governance is real work the participants must do, and the substrate provides no scaffolding for it. This is a feature, not a gap: the substrate&rsquo;s silence lets assemblies choose the form appropriate to their function &mdash; cooperative, corporate, constitutional, or none. The same absence cuts the other way, and the honest statement of it belongs here: concentrations that form at the graph layer &mdash; of retroactive reward accrual, of token holdings, of first-registered names &mdash; meet no governor either, and the design&rsquo;s answer to them is competition and disclosure rather than administration, which is a claim whose test is empirical rather than architectural. The legal-scaffolding work developed within COALA (De Filippi &amp; Hassan, 2016) remains useful for assemblies that need conventional legal personality; it becomes one option among many rather than a precondition.
                </PaperRun>

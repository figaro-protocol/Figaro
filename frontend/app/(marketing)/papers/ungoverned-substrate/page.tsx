        ...
        >
            ...
            <PaperSection title="6. Where Governance Returns: At the Graph">
                ...
                <PaperRun title="How DAOs use the substrate without governing it.">
                    A common objection: DAOs need governance, the primitive is meant for DAOs to use, therefore the primitive needs a governance interface. The objection mistakes a substrate property for a runtime requirement. <strong>The kernel verifies both buyer and seller signatures by ECDSA recovery &mdash; the buyer and the seller are always externally-owned accounts (EOAs), never contracts.</strong> A DAO or multisig authorizes an EOA signer upstream; the kernel sees only that EOA&rsquo;s signature. And because a permanently lost buyer key strands a process&rsquo;s bonds &mdash; there is no timeout and no recovery &mdash; buyer keys are expected to sit under recoverable custody, at the key-custody layer above the kernel.
                </PaperRun>
                <PaperRun title="Governance authorizes the signer.">
                    A DAO whose commitments require formal governance approval &mdash; quadratic-vote, delegation-based, optimistic &mdash; approves the commitment through its process; the authorized commitment is then signed by the EOA the governance designates (Compound Governor, 2020; OpenZeppelin Governor, 2024). The substrate sees the EOA&rsquo;s signature; it does not see the vote, the proposal text, or the delegation graph. The DAO&rsquo;s governance is real and operates entirely above the substrate; the substrate is invisible to the governance and the governance is invisible to the substrate.
                </PaperRun>

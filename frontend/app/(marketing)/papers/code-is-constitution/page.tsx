    ...
    return (
        <PaperLayout
            ...
            abstract={
                <>
                    <p>
                        Since Bitcoin, the public debate over crypto has been framed by a slogan: <em>code is law</em>. The slogan misstates what the technology does and invites the wrong arguments &mdash; it casts protocols as rivals to legal systems and then loses that argument every time a community overrides its own code. This paper proposes a different framing: <em>code is constitution</em>. A constitution is not enacted law; it is the entrenched procedural layer beneath enactment &mdash; rules about rules, held stable within a normative community that makes them legible and acceptable. Sufficiently decentralized protocols have exactly this shape: the mathematics sets the rules of the game, the community sets the norms under which those rules are read, and ordinary law is not displaced but re-seated at the boundary, where courts consume the protocol&rsquo;s evidence rather than operate its core. The paper develops the framing against constitutional political economy and legal theory, tests it against a concrete artifact &mdash; a settlement kernel for trade with no administrator, no owner, and no emergency powers &mdash; and draws the practical consequence: the right demand to place on infrastructure of this kind is not &ldquo;comply as an entity&rdquo; but &ldquo;remain neutral as a procedure,&rdquo; because there is no entity there to regulate, a fact at least one federal appellate court has now recognized.
                    </p>
                </>
            }
            references={
        ...
        >
            <PaperSection title="1. A Slogan That Lost Its Own Argument">
                ...
                <p>
                    The inversion failed empirically within its first decade. When the DAO was drained in 2016, the Ethereum community did not accept the execution as the agreement; it forked the chain and unwound the result. The minority that kept the original chain kept the slogan; the majority kept the users. Whatever one thinks of that episode, its lesson is structural: the deepest layer of a blockchain is not its code but the social layer that decides which code to run.
                </p>
                <p>
                    Notice what the fork actually was. A community exercised constituent power over its enacted rules &mdash; the thing constitutions are <em>for</em>. &ldquo;Code is law&rdquo; cannot describe the most important event in its own history. &ldquo;Code is constitution&rdquo; describes it natively: enacted rules executed faithfully, beneath them an extraordinary social process that can, at extraordinary cost, re-found the order. The strongest objection to code-finality is not an objection to the constitutional framing; it is evidence for it.
                </p>
                <p>
                    The same conclusion was reached from inside the protocol-design community itself. Vlad Zamfir&rsquo;s case against &ldquo;Szabo&rsquo;s law&rdquo; &mdash; the maxim that a blockchain&rsquo;s rules should change only for technical maintenance &mdash; insisted that blockchain governance is, and ought to remain, a social process: the participants govern the protocol, not the reverse, and a crypto-legal order that pretends otherwise is making a political claim while denying that it is one (Zamfir, 2019). That argument, often read as a rejection of rule-by-code, is better read as the constitutional framing stated from the governance side: code can hold the entrenched layer, but only a community can hold the constituent one.
                </p>
            </PaperSection>
            ...
            <PaperSection title="4. What Capture Actually Targets">
                ...
                <p>
                    Three properties do the work. The first is <em>ownerlessness</em>: entity-targeted law &mdash; which is most law &mdash; needs a defendant, and a system with no operator, no issuer, and no promoter offers none. This is the substance behind the &ldquo;sufficiently decentralized&rdquo; standard articulated for securities law: where no central party&rsquo;s managerial efforts drive the enterprise, the regulatory category fails to attach (Hinman, 2018). The second is <em>credible neutrality</em>: when a mechanism visibly favors no one, capturing it yields no rent and suppressing it carries political cost that suppressing a company does not (Buterin, 2020). The third is <em>forkability</em>: capture of an instance is escapable by exit, so the prize for capture is an empty room.
                </p>
                <p>

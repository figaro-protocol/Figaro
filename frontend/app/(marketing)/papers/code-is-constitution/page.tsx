    ...
    return (
        ...
        >
            <PaperSection title="1. A Slogan That Lost Its Own Argument">
                ...
                <p>
                    One clarification governs everything that follows. <em>Constitution</em> is used here in the constitutional-political-economy sense &mdash; the rule-choosing level, an entrenched procedural stratum that fixes how commitments are recognized and what no rule may do &mdash; and not in the sense of an order that enforces anything against anyone. On enforcement the claim of this paper is the modest evidentiary one: the record the mechanism produces is what forums read. Resolution is on-chain by nature and adjudication off-chain by nature, so what the protocol supplies to law is a record that existing forums already know how to consume, and what it substitutes for is the coercive apparatus&rsquo;s resolution-enforcement function alone, leaving every other function of law where it stood. The evidentiary analysis and the coercion-substitution analysis are their own treatments&rsquo; subjects; the constitutional framing below adds a description of <em>which layer of rules</em> such an artifact occupies &mdash; no enforcement capacity &mdash; and wherever the two registers appear to diverge &mdash; Section 6 returns to the divergence directly &mdash; the evidentiary one states the reality and this one states the shape.
                </p>
            </PaperSection>
            ...
            <PaperSection title="5. What Capture Actually Targets">
                ...
                <p>
                    That distinction states the correct resolution between such systems and the state, and the constitutional framing lets it be said in one line: <strong>regulate actors, not arithmetic.</strong> A constitution does not abolish ordinary law; it allocates it. Participants at the edges are taxed, licensed, and held to consumer protection as they always were &mdash; and the protocol, for its part, <em>supplies</em> the law&rsquo;s raw material: every commitment, bond, attestation, and resolution, timestamped, immutable, and legible to any forum. Infrastructure of this kind is not a jurisdiction-evasion device. It is the most subpoena-friendly evidence layer commerce has ever had.
                </p>
            </PaperSection>
            ...
            <PaperSection title="7. What the Reframing Changes">
                ...
                <p>
                    For lawyers and regulators, the framing replaces a dead-end question with a productive one. &ldquo;Is this legal?&rdquo; has no purchase on an artifact that is decentralized and permissionless. &ldquo;What layer of rules is this, and who are the actors at its edges?&rdquo; routes analysis to where it can succeed &mdash; and it is a question lawyers already know how to ask, because it is the question federal systems pose every day.
                </p>
                <p>

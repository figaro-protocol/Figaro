        ...
        >
            ...
            <PaperSection title="5. Tier-1 Graph Weighting">
                ...
                <PaperRun title="Topology weight.">
                    <Math>{"w_{\\text{topo}}"}</Math> is the clause&rsquo;s mean position in the process chains it appeared in over the window, clamped to <Math>{"[1.0, 3.0]"}</Math>. Clauses used deeper in process chains &mdash; further from the root buyer, where progressive collateralization has accumulated more upstream value and more coordination depends on correct attestation &mdash; weigh more. Depth is a proxy for structural load: a clause that reliably carries meaning at chain position three is doing more coordination work than one used only at the root.
                </PaperRun>

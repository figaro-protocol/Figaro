    ...
    return (
        ...
        >
            ...
            <PaperSection title="7. The Concentration Cap">
                ...
                <p>
                    Capped shares scale to FIG amounts against the tranche budget, and the resulting <Math>{"(\\text{wallet}, \\text{amount})"}</Math> pairs form the leaves of the tranche&rsquo;s Merkle tree.
                </p>
            </PaperSection>

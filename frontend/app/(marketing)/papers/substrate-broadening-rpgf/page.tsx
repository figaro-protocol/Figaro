        ...
        >
            ...
            <PaperSection title="2. The Allocation Problem">
                ...
                <PaperRun title="To whom.">
                    A schema&rsquo;s allocation goes to its <code>schemaAuthor</code> &mdash; the first-write-wins wallet that registered the schema on the registry. One schema, one recipient. There is no per-attestation, per-seller, or per-settlement reward path anywhere in the system: an seller who attests heavily under someone else&rsquo;s schema earns nothing from RPGF, and a buyer who settles a thousand processes earns nothing from RPGF. The recipient set is exactly the set of schema authors, determined by registry state, with no curation step.
                </PaperRun>

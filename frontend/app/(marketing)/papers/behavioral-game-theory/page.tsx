    ...
    return (
        ...
        >
            <PaperSection title="1. Introduction">
                ...
                <p>
                    The full-rationality equilibrium argument for the bonded primitive establishes that cooperation is weakly dominant for both parties in the bonded game, and is the unique profile surviving iterated elimination of weakly dominated strategies. The proof assumes complete information, full rationality, no non-pecuniary preferences, and no coordination failure under pessimistic beliefs. The result holds within those assumptions. The present paper asks: how does the result carry over when the assumptions are weakened in the directions the experimental literature has identified as empirically relevant?
                </p>

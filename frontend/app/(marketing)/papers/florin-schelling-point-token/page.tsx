        ...
        <PaperLayout slug="florin-schelling-point-token"
            ...
            abstract={
                <>
                    ...
                    <p>
                        The positive design content is modest and targeted: a fixed one-billion-unit cap enforced by two complementary supply-integrity mechanisms, a one-way deployer-renouncement latch that freezes the allocation plan at deployment, and a single staged distribution of 60% of supply, paid out over nine annual periods on a rising budget schedule, to the authors of record of the artifacts real trade used &mdash; clause authors and assembly designers alike, on identical terms. We lay this design out in detail and close with an honest analysis of how the florin can lose its focal-point status and what the design does and does not defend against.
                    </p>
                    <p>
        ...
        >
            ...
            <PaperSection title="6. Allocation: 7 / 3 / 30 / 60">
                ...
                <ul className="space-y-1 list-disc pl-6 text-sm">
                    ...
                    <li><strong>Artifact authors and designers</strong> &mdash; 60% (600M) &mdash; claimed pro rata over nine annual accrual periods, ending at years 1 through 9, with per-period budgets grouped into three rising tranches (15% / 30% / 55%).</li>
                </ul>
            ...
            <PaperSection title="7. Staged Distribution over Counted Adoption">
                <p>
                    The 600M share is realized by a single minter holding one budget per accrual period, all nine fixed at deployment, with no privileged path to add a period, extend the schedule, resize a budget, or alter who is eligible. Adoption of the artifacts the substrate-broadening rule scores is counted on chain the moment it happens, by a permissionless recording call that verifies for itself that the order settled and that the artifact was committed in the signed agreement, so each period&rsquo;s payout is a division over quantities the chain already holds &mdash; minted straight to the claimant, with no root to post, no bond, and no challenge to any of it.
                </p>
                ...
                <PaperRun title="One-shot per (period, address).">
                    Each (period, address) pair is marked claimed on a successful claim and checked on every entry. A given account can claim at most once per period, presenting every artifact it authored or designed &mdash; clauses and assemblies together, checked against their own registries &mdash; in that single call. No top-up, no re-claim, no rebate.
                </PaperRun>

        ...
        >
            ...
            <PaperSection title="6. Allocation: 7 / 3 / 30 / 60">
                ...
                <ul className="space-y-1 list-disc pl-6 text-sm">
                    ...
                    <li><strong>Airdrop</strong> &mdash; 60% (600M) &mdash; nine annual periods, ending at years 1 through 9, with per-period budgets grouped into three rising tranches (15% / 30% / 55%).</li>
                </ul>
                ...
                <PaperRun title="Airdrop allocation (60%).">
                    The majority share, allocated over a calendar window in nine annual instalments of rising size. The structure is designed to (a) reach the artifact-author participants, (b) reward sustained substrate contribution, since a contributor whose work is still being adopted in year seven is paid for that year as fully as for their first, and (c) avoid the &ldquo;dump-on-launch&rdquo; dynamic of single-event airdrops by spreading the supply emission over a nine-year horizon. The recipients and amounts within each period are decided by the substrate-broadening formula &mdash; the retroactive rule that rewards authors of record in proportion to how much their artifacts broadened the range of coordination the substrate can express &mdash; computed over settled on-chain history; the allocation is not a generic user airdrop.
                </PaperRun>
                <p>
            ...
            <PaperSection title="7. Staged Distribution over Counted Adoption">
                ...
                <PaperRun title="One-shot per (period, address).">
                    Each (period, address) pair is marked claimed on a successful claim and checked on every entry. A given account can claim at most once per period, presenting everything it authored in that single call. No top-up, no re-claim, no rebate.
                </PaperRun>

    ...
    return (
        ...
        >
            ...
            <PaperSection title="6. Clauses">
                <p>
                    The composition draws mostly on existing clause infrastructure. One new clause is required &mdash; a container-seal attestation &mdash; beside the already-registered Incoterms-2020 anchor (plus carrier process-log and customs-clearance candidates, treated below). The bill-of-lading transferability question is treated separately in Section 7.
                </p>
            ...
            <PaperSection title="9. Scope">
                ...
                <PaperRun title="Insurance and reinsurance.">
                    Marine insurance, P&amp;I clubs, and the general apparatus of shipping-risk underwriting continue to operate. The bonded architecture changes the risk profile that the marine-insurance markets price (smaller residual after bond allocation; concentrated risk at the carrier-bond layer; a new class of bond-forfeiture exposure at the port-supplier layer) but does not displace the insurance function. We expect the marine-insurance markets to develop fluent products around the bonded architecture as the architecture diffuses.
                </PaperRun>

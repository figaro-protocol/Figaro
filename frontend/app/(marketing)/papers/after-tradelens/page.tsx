        ...
        >
            ...
            <PaperSection title="4. The Assembly">
                ...
                <ul className="space-y-2 list-disc pl-6 text-sm">
                    ...
                    <li><em>Customs agent</em>: a customs-clearance attestation recording the customs authority&rsquo;s determination (a candidate seller-process schema, not yet in the registered set), plus payment for entry-filing services.</li>

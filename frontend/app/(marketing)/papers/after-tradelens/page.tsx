    ...
    return (
        <PaperLayout slug="after-tradelens"
            ...
            abstract={
                <>
                    ...
                    <p>
                        The clauses the composition draws on are largely existing infrastructure (commerce, geolocation, modalities, proximity-policy, emissions) &mdash; the proof that a container transfer occurred at the agreed place rides proximity-policy&rsquo;s runtime witness stage rather than a separate proof clause; new clauses (container-seal, an Incoterms-2020 anchor) and proposed candidates (a carrier process-log, a customs-clearance clause) extend the protocol&rsquo;s surface additively, without touching the kernel. We also treat the bill-of-lading transferability question through the cancellable-seller / counter-process pattern that expresses transferability at the protocol layer without weakening the kernel&rsquo;s invariants.
                    </p>
                    <p>
        ...
        >
            ...
            <PaperSection title="6. Clauses">
                <p>
                    The composition draws mostly on existing clause infrastructure. Two new clauses are required (plus carrier process-log and customs-clearance candidates, treated below): a container-seal attestation and an Incoterms-2020 anchor. The bill-of-lading transferability question is treated separately in Section 7.
                </p>
                ...
                <p>
                    These clauses are already registered; no further authoring work is needed for them. Two further attestations ride candidate clauses that do not yet exist in the registered set: the carrier&rsquo;s per-role event log over the multi-stop carrier process (a proposed sister clause following merchant-process / courier-process), and the customs-clearance determination recorded by the customs-authority wallet. Each is a candidate composition, authored and registered the same way as the two new clauses below.
                </p>
            ...
            <PaperSection title="7. Bill of Lading Transferability">
                ...
                <p>
                    The pattern is a sketch, not a deliverable mechanism. Three elements lie outside the kernel-discipline guarantee and must be specified by the parties at agreement signing rather than relied on as architectural invariants. <em>Sub-seller consent under the wrapper</em>: the wrapper turns on programmatic acknowledgement of cancellation by the affected sub-seller under a fee schedule pre-agreed at commit time; whether that consent at commit time satisfies the kernel-discipline reading of counterparty consent at the moment of cancellation is a design-discipline question the parties resolve in the off-chain agreement. <em>Cargo-handoff operationalization</em>: a fresh transport process for the remaining legs requires the original carrier to release cargo to the new carrier; the cargo handoff is a real-world event the off-chain agreement attaches an attestation surface to (a proximity-policy hand-off attestation between the two carriers, with the original buyer counter-signing). <em>Cancellation-fee arithmetic</em>: the fee schedule must be high enough that sub-sellers do not face an early-exit option they will refuse, and low enough that the transfer use case remains operational; specific values are agreement-shaped, not architectural.
                </p>
                <p>

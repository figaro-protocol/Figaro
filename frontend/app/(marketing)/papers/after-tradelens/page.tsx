        ...
        >
            ...
            <PaperSection title="4. The Assembly">
                ...
                <ul className="space-y-2 list-disc pl-6 text-sm">
                    <li><em>Shipper-of-record</em>: proximity-proof on goods presented for shipment, optional emissions-disclosure disclosure for manufacturing emissions.</li>
                    ...
                    <li><em>Ocean carrier</em>: an Incoterms-2020 clause anchoring the shipment term and named place; proximity-proof on transfer to the vessel and at discharge; container-seal sealing events through the voyage; geolocation vessel-position attestations on the voyage cadence; emissions-disclosure disclosure for voyage emissions; for reefer cargo, cold-chain attestations.</li>

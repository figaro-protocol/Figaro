    ...
    return (
        ...
        >
            ...
            <PaperSection title="7. Bill of Lading Transferability">
                ...
                <p>
                    The equilibrium survives the netting, which is what makes it a mechanism rather than a hope. Every bond stays hostage through the negotiation, so each party&rsquo;s exposure is unchanged while the transfers are agreed; and resolving remains strictly dominant for the buyer once the transfers are collected, since retaining amounts bounded by the payment while forfeiting a bond of twice it is strictly worse than resolving. The pressure that makes the original schedule credible is exactly the pressure that makes its reallocation credible.
                </p>

    ...
    return (
        <PaperLayout slug="self-authenticating-data-sales"
            ...
            abstract={
                <>
                    <p>
                        A dataset sold on ordinary terms suffers Arrow&rsquo;s information paradox: the buyer cannot value the data without seeing it, and having seen it, has no reason to pay. We show that a settlement layer which records trade as merkle-committed agreements dissolves the paradox economically rather than cryptographically: each record offered for sale carries an inclusion proof against the on-chain fingerprint of the settled process that produced it, so what is sold arrives self-authenticating &mdash; provably a real record of a real trade &mdash; while the 2&times; bond makes misrepresentation of the unseen remainder an economically dominated strategy.
                    </p>
                    <p>

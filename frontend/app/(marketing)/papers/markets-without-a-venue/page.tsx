        ...
        >
            ...
            <PaperSection title="2. The Setting">
                ...
                <PaperSubsection title="2.2 What a market has to add">
                    ...
                    <p>
                        The third is where a kernel of the present kind changes the problem, because safety in a real market is two things that are usually supplied by one institution. There is <em>formation safety</em> &mdash; answering a solicitation must not expose the answerer to more than the deal it answered for &mdash; and there is <em>performance safety</em> &mdash; the counterparty, once matched, must actually deliver. Conventional venues supply both together: an exchange that holds margin is simultaneously making bidding safe and making settlement safe, and the two are not separable in its design. Here they are separable, and separated. Performance safety is the kernel&rsquo;s, complete before any market exists. Formation safety is all that the market layer must supply on its own, and the mechanisms below supply it structurally rather than by holding anything.
                    </p>
                    <p>

    ...
    return (
        ...
        >
            ...
            <PaperSection title="7. Mechanism Composition: The Coordinator Pattern">
                ...
                <PaperRun title="Schema and seller registries (src/SchemaRegistry.sol, src/SellerRegistry.sol).">

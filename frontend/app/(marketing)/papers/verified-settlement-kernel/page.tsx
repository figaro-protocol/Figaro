        ...
        >
            ...
            <PaperSection title="5. Verification Results">
                ...
                <PaperSubsection title="5.6 What the Batch Path Asks a Reader to Trust">
                    <p>
                        The direct path asks for trust in the chain beneath it and in the kernel&rsquo;s own arithmetic, and in nothing else. The batch path asks for more, and the additional assumptions deserve to be named individually rather than folded into the phrase <em>validity proof</em>. There are five, and they are not of the same kind: the first two are assumptions in the strong sense that nothing inside the system compensates for their failure, while the other three are structural &mdash; a binding, a gate, and a role, each with limits a reader can inspect rather than has to grant.
                    </p>
                    <ol className="space-y-2 list-decimal pl-6 text-sm">
            ...
            <PaperSection title="8. Conclusion">
                <p>
                    We have presented a verified implementation of the two-mechanism bonded commitment settlement primitive: an ownerless, fee-less kernel of two entry points and a minimal state footprint, with a four-method verification stack that exercises the same invariants from four methodological directions. <em>Verified</em> carries here exactly the weight Section 5.5 gave it and no more: the four methods were run by the authoring project on its own kernel, and no external audit of that work has been performed. The coordinator pattern provides a discipline for extending the kernel without weakening its equilibrium.
                </p>

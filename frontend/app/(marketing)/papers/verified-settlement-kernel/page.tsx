    ...
    return (
        ...
        >
            ...
            <PaperSection title="7. Mechanism Composition: The Coordinator Pattern">
                ...
                <p>
                    The proposition is stated here, not proved here. Its proof sketch &mdash; condition by condition, with the invariance argument that carries condition (i) &mdash; is given for the same five conditions in <Link href="/papers/protocol-extension" className="text-ink-heading hover:underline">Protocol Composition: A Decision Rule, Clause Design, and the Coordinator Pattern</Link>, &sect;5.2, where they appear as Proposition 5.2. What that argument establishes directly is that the kernel&rsquo;s invariants survive composition and that no second path to the bonded funds or to a payoff indexed on them is opened; the step from there to preservation of the parties&rsquo; equilibrium is carried by the bonding derivation&rsquo;s payoff-structure argument, which neither that paper nor this one re-proves. Readers should hold the proposition to that reading: it is a condition set that keeps the payoff structure intact, verified per composition by inspection rather than by a rule quantifying over arbitrary <Math>{"M"}</Math>.
                </p>
                <p>

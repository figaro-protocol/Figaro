        ...
        >
            ...
            <PaperSection title="7. Mechanism Composition: The Coordinator Pattern">
                ...
                <PaperRun title="Clause and participant registries.">
                    Permissionless, append-only, event-first registries. The clause registry anchors content clauses by a hash of the clause name together with a pointer to the off-chain specification. The participant registry is on-chain self-registration with a reclaimable deposit, released after a cooldown so the stake cannot be recycled across identities. Both compose with the kernel by being visible to readers and never invoking the kernel&rsquo;s settlement entry points. Conditions (i)&ndash;(iv) hold; both are pure coordination surfaces with no kernel interaction.
                </PaperRun>

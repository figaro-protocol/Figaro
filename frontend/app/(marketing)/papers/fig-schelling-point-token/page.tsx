    ...
    return (
        ...
        >
            ...
            <PaperSection title="8. Design Exclusions as Focality Preservers">
                <p>
                    The cryptoeconomic content of FIG is largely defined by what the design excludes. We catalogue the exclusions and tie each to the focality property it preserves. With the Schelling-point framing the reasons unify: each exclusion removes a class of holder whose reason for holding FIG would be something other than alignment signaling, and so each preserves Rule 1 (and, where noted, Rule 4).
                </p>
                <ul className="space-y-2 list-disc pl-6 text-sm">
                    ...
                    <li><strong>Not a fee path.</strong> Even if a future runtime layer above the kernel introduces a fee, that fee is not denominated in FIG; a fee-denomination role would recruit utility arbitrageurs who acquire FIG to transact, not to signal.</li>

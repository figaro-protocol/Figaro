        ...
        >
            ...
            <PaperSection title="5. Clauses">
                ...
                <PaperRun title="Existing clauses.">
                    The commerce clause carries the currency, payment, and itemized line-items of every commitment in the assembly &mdash; the passenger ticket and every sub-procurement commitment. The carrier-process-log clause carries staged progression as a sequence of attestations; the clause&rsquo;s staged event structure can be re-used by reinterpretation (boarding initiated, cabin ready, pushback, takeoff, arrival, or whatever projection the assembly designer adopts), without authoring a new clause. The delivery-modality clause declares the handoff points where physical exchange occurs between operational parties, and proximity-proof attests that a given handoff happened at the agreed place and time. An arbitration clause (a Kleros forum selection, say) carries the dispute-resolution choice, and an applicable-law clause the governing law, for international flights, where the parties want to specify a particular forum and law. The geolocation clause carries the origin and destination geohashes where geographic-anchoring is operationally relevant. The GHG family of clauses is available for assemblies that wish to compose carbon-emission attestations into the ticket commitment.
                </PaperRun>
                <p>
            ...
            <PaperSection title="6. Comparison with the Conventional Apparatus">
                ...
                <PaperRun title="Where value concentrates.">
                    Decomposing the journey into its resource markets makes visible which inputs carry pricing power and which do not. The aircraft is a commodity input &mdash; leased, fungible, available to any operator on similar terms; the scarce, hard-to-replicate positions are the airport slots at congested hubs and the brand. Under the decomposed regime the commodity cost-lines compete toward their cost of capital while value capture concentrates on the scarce positions. An ultra-low-cost carrier built almost entirely on commodity inputs holds the thinnest position once the inputs are individually contractable.
                </PaperRun>

        ...
        >
            ...
            <PaperSection title="2. The Kernel">
                ...
                <PaperRun title="What this buys a cross-border service.">
                    Resolution is the release of locked balances on the mechanism&rsquo;s own terms, executed by no court and dependent on no party&rsquo;s home jurisdiction. The substantive agreement remains binding under whatever law the parties name for it, and disputes about that agreement go where the parties send them; what the mechanism supplies is that the tokens at stake move by the buyer&rsquo;s acceptance rather than by an enforcement action, in a service whose providers routinely sit in a dozen legal systems at once.
                </PaperRun>
            </PaperSection>
            ...
            <PaperSection title="3. The Bonded Architecture Applied to Air Service">
                ...
                <PaperRun title="Buyer-initiated atomic resolution.">
                    The passenger resolves, and the entire process resolves simultaneously. Every active order is resolved together or none is. The passenger is the only party whose action is required for resolution &mdash; the call is the buyer&rsquo;s own, and no provider countersigns it &mdash; and atomicity guarantees that no subset of orders resolves without the rest.
                </PaperRun>
            ...
            <PaperSection title="4. Disruption Resolution Under Buyer Dominance">
                ...
                <PaperSubsection title="4.1 The primary mechanism: cohort compensation under bond pressure">
                    ...
                    <PaperRun title="Providers determine and pay compensation themselves.">
                        When operational disruption leaves the passenger worse off than the agreement contemplated, each provider faces the arithmetic of Section 2: a provider that has performed is out <Math>{"P_i + 2G_i"}</Math> relative to a resolved process, and one that has not yet performed is out at least <Math>{"P_i + G_i"}</Math>. Both figures dwarf a proportionate contribution to making the passenger willing to accept. The route those figures open runs as follows.
                    </PaperRun>
                    <p>
                ...
                <PaperSubsection title="4.2 Fallback mechanisms">
                    <p>
                        The primary mechanism is where the bonded positions point disruption first: into the cohort, decided directly. Fallback mechanisms engage where it does not come to rest there, or where the disruption involves a class of issue it cannot address. We list them in the order of operational engagement.
                    </p>
                    <p>
                    ...
                    <p>
                        <em>Dispute forums.</em> The agreement named in the bonded commitment may name a forum &mdash; an arbitration center, an online dispute-resolution platform, a Schelling-point juror system &mdash; and where none is named, whichever forum would have heard the parties anyway remains available. A forum engages when cohort compensation does not decide the matter, typically because the dispute is substantive in a way bond posture cannot address (duress, mistake, frustration, illegality, public-policy concerns). It rules while the process stands open, on the record for what was undertaken and on the parties&rsquo; own evidence for what happened, and it cannot resolve the process in the passenger&rsquo;s place. Its ruling reaches the parties as rulings ordinarily do, through their exposure outside the process, and it feeds the remedy the passenger will accept.
                    </p>
                    <p>
                        <em>Insurance compositions.</em> A passenger or provider wanting cover against risks the bonded positions cannot absorb (catastrophic events, multi-day weather disruption, force majeure) composes a parallel bonded process with an insurer. The insurer&rsquo;s own bond stands behind its undertaking, and its resolution is its own bonded event; the composition changes nothing inside the original process.
                    </p>
                    <p>

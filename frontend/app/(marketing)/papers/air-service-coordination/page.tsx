        ...
        >
            ...
            <PaperSection title="4. Disruption Resolution Under Buyer Dominance">
                ...
                <PaperSubsection title="4.1 The primary mechanism: cohort compensation under bond pressure">
                    ...
                    <p>
                        This happens fast, and it happens at the operational boundary &mdash; the gate, the destination service desk, the runtime surface the assembly&rsquo;s designer provides &mdash; rather than in a filing six months later. It happens before insurance claims, before dispute forums, before regulatory engagement, because that is where the bonded positions point.
                    </p>
            ...
            <PaperSection title="8. Conclusion">
                ...
                <p>
                    What that produces operationally is the paper&rsquo;s substantive claim: when something goes wrong, the parties who can fix it are the ones standing in unreleased bonds, they can compute what the failure costs them, and they can reach the passenger directly. Compensation is determined and paid inside the cohort, before insurance, before forums, before regulators. The reduction in cascading-delay loss follows from the same bond posture, as a by-product rather than as the aim. The architecture composes with existing safety regulation, crew-labor protections, insurance markets, and competition regimes; it changes the cost-flow path without displacing the regulatory and contractual layers around it. What the paper supplies is the assembly &mdash; the configuration of bonded commits, the credential clauses, the schedule sister-pair, the flight-phase log, and the disruption-resolution mechanism &mdash; that turns a general settlement primitive into a working air-service coordination architecture, together with an honest statement of the one assumption in it that no mechanism can discharge.
                </p>
            </PaperSection>
        </PaperLayout>
    );

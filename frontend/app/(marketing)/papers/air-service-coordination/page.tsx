        ...
        >
            ...
            <PaperSection title="4. Disruption Resolution Under Buyer Dominance">
                ...
                <PaperSubsection title="4.2 Fallback mechanisms">
                    ...
                    <p>
                        <em>Coordination tokens (runtime layer &mdash; outside the recourse ordering).</em> Where the assembly composes around a coordination token, the substrate&rsquo;s operational state registers as token value. Token holders bear operational quality through value impact rather than through direct compensation. This is not a rung a dispute escalates to: token-value reflection is a diffuse signal running in parallel with the per-edge compensation mechanism, not a forum and not a substitute for one. We note it here for completeness and set it aside from the ordered recourse path.
                    </p>
                    <p>

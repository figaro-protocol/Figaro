    ...
    return (
        <section className="container mx-auto px-6 pt-24 pb-16 max-w-2xl">
            ...
            <p className="text-base text-ink-body leading-relaxed mb-4">
                Why twice the value, and not the payment plus a small margin? Because at twice the value there is no amount that is clever to steal &mdash; the theorem, its proof, and every case it excludes are in <Link href="/papers/asymmetric-bonding" className="text-ink-heading font-medium hover:underline">Asymmetric Bonding and Buyer Dominance</Link>. What it comes to, for either side:
            </p>

        ...
        <>
            ...
            <MarketingSection title="The verification stack" sectionId="verification">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    What is in place today is a verification stack &mdash; seven independent benches: six on the protocol&apos;s contracts and one on the equilibrium algebra those contracts enforce &mdash; each from a different angle. Seven, and not one, because each catches a class of defect the others structurally cannot. What each class of check covers and what it structurally cannot reach, for the kernel and its two composition surfaces, and the bounds the kernel's model runs under, are the subject of <Link href="/papers/verified-settlement-kernel" className="text-ink-heading font-medium hover:underline">A Verified Resolution Kernel</Link>; the counts on this page are derived from the tree, and the paper names no tool and states no count:
                </p>

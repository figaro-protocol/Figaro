        ...
        <>
            ...
            <MarketingSection title="The verification stack" sectionId="verification">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    What is in place today is a verification stack &mdash; six independent benches, each targeting the protocol&apos;s contracts &mdash; and the argument they exist to support &mdash; from a different angle. Six, and not one, because each catches a class of defect the others structurally cannot. What each method covers, what it structurally cannot reach, and the bounds every model-checked configuration runs under are set out method by method in <Link href="/papers/verified-settlement-kernel" className="text-ink-heading font-medium hover:underline">A Verified Settlement Kernel</Link>:
                </p>
                <ul className="space-y-2 text-base text-ink-body mb-5 ml-6">
                    <li>&mdash; <strong className="text-ink-heading font-medium">Foundry</strong>: the unit + integration suite &mdash; 302 test functions. Class: <em>behavioral and regression</em> &mdash; what a contract does on concrete inputs, and what it stops doing after an edit. It proves nothing about the inputs nobody wrote a test for.</li>

        ...
        <>
            ...
            <MarketingSection title="The verification stack" sectionId="verification">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    What is in place today is a verification stack &mdash; seven independent benches: six on the protocol&apos;s contracts and one on the equilibrium algebra those contracts enforce &mdash; each from a different angle. Seven, and not one, because each catches a class of defect the others structurally cannot. What each machine method covers, what it structurally cannot reach, and the bounds every model-checked configuration runs under are the subject of <Link href="/papers/verified-settlement-kernel" className="text-ink-heading font-medium hover:underline">A Verified Settlement Kernel</Link>; the counts on this page are derived from the tree, not quoted from the paper:
                </p>
                <ul className="space-y-2 text-base text-ink-body mb-5 ml-6">
                    <li>&mdash; <strong className="text-ink-heading font-medium">Foundry</strong>: the unit + integration suite &mdash; 312 test functions. Class: <em>behavioral and regression</em> &mdash; what a contract does on concrete inputs, and what it stops doing after an edit. It proves nothing about the inputs nobody wrote a test for.</li>

    ...
    return (
        <>
            ...
            <MarketingSection title="Third order: the state's modality inverts." sectionId="third-order">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The state persists; what changes is its modality &mdash; from compelling reports to reading a record, from an authority that must be believed to one that publishes rules others compose with.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

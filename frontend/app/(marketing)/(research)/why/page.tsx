    ...
    return (
        <>
            ...
            <MarketingSection title="What this descends from.">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    Three corrections to the inheritance, stated plainly. The first is what the tradition never solved. It won sovereign identity, sovereign currency, and sovereign privacy &mdash; and left untouched the element that fails between sovereign strangers: consideration, the part of a contract that makes a promise to deliver credible. Sovereignty without consideration is why cyberspace was colonized by the platform intermediaries the movement had declared obsolete. Somebody still had to make the stranger&apos;s promise good, and the only answer on offer was an institution in the middle holding the payment and taking a cut for the service. Figaro completes that missing element with bonds rather than an institution &mdash; the mechanism is on <Link href="/kernel" className="text-ink-heading font-medium hover:underline">/kernel</Link>. Once consideration holds on its own, the rest of the contract rebuilds above that floor without the institution that once carried it: the terms as clauses anyone may write and publish, offer and acceptance as assemblies and the checkout that fills one in, capacity as admission nobody grants, mutual assent as the two parties&apos; own signatures, legality as the forum the agreement names and the court that reads its data either way. Each limb has a page of its own here; none of them puts a party back in the middle.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    The third correction is about politics, and it is a refusal. The
                    kernel is ideologically agnostic; the graph the parties compose above
                    it is the politics. FigaroCore takes no position on currency,
                    jurisdiction, identity, forum, role structure, or contribution
                    metric &mdash; a market-liberal market, a cooperative, an
                    Islamic-finance market, and a mutual-aid circle all run on the same
                    kernel, and the kernel prefers none of them. What each one is lives
                    in the clauses and assemblies its designers compose, where a
                    normative choice is legible as a choice rather than a property of
                    the infrastructure.
                </p>
            </MarketingSection>

            <MarketingSection title="Firm, platform, court &mdash; and the fourth way.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    A promise between strangers is not credible on its own, and history has answered that in three ways, each locating the cost of enforcement with someone other than the two people trading. Bring the trade inside a hierarchy, and it stops being a promise at all &mdash; a manager directs, an employee complies, and the enforcement problem disappears into an org chart. Route it through a platform that stands behind both sides, holds the payment, and reverses it if something goes wrong &mdash; paid in a cut of the trade and in the record of who traded what with whom. Or leave the two parties alone and let a court hear the complaint afterward, at the state&rsquo;s expense and the parties&rsquo;, inside whatever jurisdiction reaches them both.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    Figaro is a fourth answer, not a replacement for the other three: the two parties carry the cost themselves, locking a bond before the trade that only completing it refunds. Each of the four wins on its own ground &mdash; a hierarchy where the same partners deal with each other often enough to be worth the overhead, a platform where the hard part is finding a counterparty at all, a court where the amount at stake can carry a lawsuit or the harm reaches someone who was never a party to the deal. Where the fourth wins is narrower, and where it wins, nothing else was on offer: two strangers with no institution in common, no shared court, and often no legal personality between them at all &mdash; just a key and a balance. There, the bonded commitment is not the cheaper option. It is the only one.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                    The comparison &mdash; what each of the four charges, who ends up holding the record of the trade, how each one fails &mdash; is worked out axis by axis in <Link href="/papers/coordination-substrates" className="text-ink-heading font-medium hover:underline">Coordination Substrates</Link>. None of the three older answers goes away; the paper is about where each still wins.
                </p>
            </MarketingSection>
            ...
            <MarketingSection title="The current moment." bottomPad="wide">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-8">
                    Figaro is one contribution to a substrate that captures less well: economic rules that are common knowledge, enforced by mathematics, permissionless and decentralized. Clarity is a partial defense. It is the defense the third era makes available.
                </p>

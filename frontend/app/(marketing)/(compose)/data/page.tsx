    ...
    return (
        <>
            ...
            <MarketingSection title="What the chain keeps.">
                <p className="text-base text-ink-body leading-relaxed">
                    Resolving a trade produces a fingerprint on-chain &mdash; a hash of the agreement, timestamped and permanent &mdash; never the agreement itself. What that buys is narrow, and worth being exact about: it proves that a specific piece of data matches a specific resolved trade, and proves nothing about what that data says. Why a boundary this thin can hold an unbounded world honest is on <Link href="/invariants" className="text-ink-heading font-medium hover:underline">Invariants</Link>.
                </p>
            </MarketingSection>

            <MarketingSection title="The half that's shared.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    One part of every trade is meant to be public: who moved what, to whom, roughly where, and whether it resolved &mdash; a neighborhood&apos;s demand, a seller&apos;s resolution history, a route&apos;s reliability, all readable straight from the chain, by anyone, without asking permission. This is the map a delivery platform used to keep to itself so it alone could match supply to demand. Figaro puts it in the open by construction instead, and the network&apos;s own token pays whoever keeps drawing it &mdash; see <Link href="/rpgf" className="text-ink-heading font-medium hover:underline">how that works</Link>.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                    That inversion is the whole arrangement, and it is easiest to see as a direction of travel. Value converges: every payment and every stake is pulled into one resolution, and radiates back out &mdash; payouts and stakes together, in a single transaction &mdash; the moment the buyer closes. The data does the opposite. Only a fingerprint crosses onto the chain; the detail disperses to the people who produced it; and what travels outward is the aggregate map, to everyone at once. A platform ran both the other way.
                </p>
                <p className="text-base text-ink-body leading-relaxed mt-5">
                    Public is not the same as checked, and the map is explicit about the difference. A stake that was locked and a payout that was released are <em>protocol-enforced</em> &mdash; the protocol moved that value itself. A service area a seller published is <em>institution-declared</em>: it is on the map because someone put it there and nothing on chain verified it, and what argues for its accuracy is the demand and the stake that seller has riding on being found where it says it is. A disclosure is <em>protocol-derived</em> &mdash; the chain holds its fingerprint and the moment it was committed, which fixes which document was agreed and nothing about whether that document is accurate &mdash; and a swap routed through another contract is <em>composition-derived</em>, true by that contract&apos;s own rules rather than this protocol&apos;s. So nobody has to infer which of the four they are reading: the explorer names the boundary beside each layer of the map it draws.
                </p>
            ...
            <MarketingSection title="What arrives is provable, not promised.">
                <p className="text-base text-ink-body leading-relaxed">
                    Licensed data does not arrive on the seller&apos;s word. Each delivery carries a proof tying it back to the exact resolved trade that produced it, checked against that trade&apos;s own on-chain fingerprint &mdash; so a buyer can confirm the data is genuine without trusting the seller selling it. That is what makes selling access to it practical in the first place: the same doubled stake that secures every other trade here replaces the usual need to inspect the goods before agreeing to pay for them.
                </p>
            </MarketingSection>

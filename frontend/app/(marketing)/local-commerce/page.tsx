    ...
    return (
        <>
            ...
            <section className="container mx-auto px-6 pb-12 max-w-3xl border-t border-default pt-12">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    That dissolving institution left something behind that an ordinary evening never does: you saw where your payment was going before you committed to any of it. Order from an ordinary restaurant chain and it lands as one lump sum; where it goes after that &mdash; the cooks, the courier, the farm that grew the tomatoes, the landlord, the owner&apos;s cut &mdash; is decided inside the company, privately, after the fact. Order this way and you saw the split at checkout: 8.40 to the kitchen, 2.10 to the courier, 0.30 to the farm &mdash; a different set of figures than the other worked examples on this site, same 2&times; rule under all of them &mdash; the complete P&amp;L of your dinner, line by line, before you paid a cent.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
            ...
            <section className="container mx-auto px-6 pb-12 max-w-3xl border-t border-default pt-12">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    Some things a dinner can&apos;t settle by itself &mdash; a real dispute, a loss that runs past the meal, a question only a court or an insurer can answer. The deal doesn&apos;t pretend to absorb those. What it leaves instead is a clean record: every step it wrote down, timestamped and unforgeable, is there for whatever outside forum the parties turn to. Ordinary agreements open by asking both sides for good faith. This one asks each side to back its word with a stake &mdash; and then there is nothing left to take on trust. A court doesn&apos;t reach into the lockbox either: a judgment collects from the loser&apos;s other assets the ordinary way, and this record just makes that case faster to win &mdash; the full layering is at <Link href="/security" className="text-ink-heading font-medium hover:underline">security</Link>.
                </p>
            </section>

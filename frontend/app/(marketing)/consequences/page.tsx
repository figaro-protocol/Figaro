        ...
        <>
            ...
            <MarketingSection title="The dilemma." sectionId="dilemma">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    What it does, mechanically: two strangers lock collateral &mdash; the buyer twice the payment, the seller twice the cumulative value flowing through them. Cooperation weakly dominates defection for both, from the arithmetic alone. The buyer resolves; bonds return; payment flows. No owner, no fee, no admin, no escape hatch. The derivation is on <Link href="/protocol" className="text-ink-heading font-medium hover:underline">Protocol</Link>; the formal proofs are in <Link href="/cryptoeconomics" className="text-ink-heading font-medium hover:underline">Cryptoeconomics</Link>. This page assumes both and asks what follows from them.
                </p>
            </MarketingSection>
            ...
            <MarketingSection title="The responsibility that remains." sectionId="responsibility" bottomPad="wide">
                ...
                <ul className="space-y-3 text-base">
                    ...
                    <li>
                        <Link href="/cryptoeconomics" className="text-ink-heading font-medium hover:underline">Cryptoeconomics</Link>

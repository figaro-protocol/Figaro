    ...
    return (
        <>
            ...
            <MarketingSection title="The reserve grows as the network does.">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    That end is the shape of a bootstrap, not the lifespan of the commons. The reserve exists to get the shared graphs built while they are still too thin to pay for themselves; by the late tranches, an author&apos;s real income is the market their work carries &mdash; the assemblies adopted, the data sold, the deals settled through their terms. What continues past year nine continues on its own legs: the DAO&apos;s treasury has no clock and spends by judgment for as long as it lasts, donations arrive whenever anyone cares to make one, and nothing stops anyone &mdash; the DAO included &mdash; from standing up a successor rewards program of their own design, funded however its author chooses. The protocol is open, and this program holds no franchise on rewarding the work built above it.
                </p>
            </MarketingSection>

        ...
        <>
            ...
            <MarketingSection title="A grant, not an income.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    The three hundred million was minted to the treasury at genesis, whole, with no vesting and no unlock &mdash; and nothing replenishes it. It is not a share of anything, not a stream, and not topped up by trade. When it is gone it is gone.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    There are three ways to spend it, and nothing gates which. It can stand up a public-goods programme &mdash; a grant, a bounty, a commons initiative &mdash; by ordinary transfer, decided and paid without a crowd, a round, or a matching formula anywhere in the loop. It can pay a third party for work done: design, an audit, anything an organisation buys, an ordinary transfer on trust like any invoice. Or it can buy through the protocol as an ordinary bonded buyer, when the payment should be secured by the mechanism rather than trusted.
                </p>

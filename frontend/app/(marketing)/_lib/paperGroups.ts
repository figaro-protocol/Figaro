...
export const PAPER_GROUPS: PaperGroup[] = [
    ...
    },
    {
        ...
        papers: [
            ...
            { title: "Substrate-Broadening Retroactive Public-Goods Funding", href: "/papers/substrate-broadening-rpgf", blurb: "An optimistic, deterministically verifiable allocation that distributes florins to clause authors and assembly designers, scoring artifacts by counterparty diversity over raw volume under an open challenge window." },
        ],
    },
    {

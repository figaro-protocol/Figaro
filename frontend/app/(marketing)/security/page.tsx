    ...
    return (
        <>
            ...
            <MarketingSection title="What if the counterparty doesn't deliver?" sectionId="counterparty">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    If you are used to card payments, here is the direct comparison. Before settlement, the equivalent of a chargeback is the buyer&apos;s withheld close &mdash; nothing settles until it&apos;s right, which is a stronger position than clawing a payment back after the fact usually is. After settlement there is deliberately no unwind: no chargeback, no reversal, no clawback window, ever. That is the trade-off stated plainly &mdash; once the buyer signs the close, it is final, and recourse from there is the on-chain record plus <Link href="#layers" className="text-ink-heading font-medium hover:underline">ordinary law</Link>, not a request the protocol can grant.
                </p>

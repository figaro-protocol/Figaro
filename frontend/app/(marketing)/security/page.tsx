    ...
    return (
        <>
            ...
            <MarketingSection title="What else you should know." sectionId="compatibility">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    <strong className="text-ink-heading font-medium">Gas ceiling per process.</strong> A single process settled through the direct on-chain path is bounded by Ethereum&apos;s block gas limit to roughly 2,145 orders. Large coordinations should compose across processes &mdash; the kernel supports this structurally &mdash; rather than push a single process toward the ceiling. The batched path&apos;s ceiling is different and is dominated by net-position count, not raw order count.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

    ...
    return (
        <>
            ...
            <MarketingSection title="Figaro is cryptoeconomics for trade.">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    There is a deeper point in that neutrality. Everyday life has no ready category for value that is neither spent nor invested &mdash; yet that missing third category sits at the heart of every economic system, and each system answers it differently. The kernel answers for none of them. The graph tier above it can express any of them &mdash; a market arrangement, a cooperative one, mutual aid, and others still. And because every process is transparent and every participant self-sovereign, free to choose what they join and which token carries it, people can fuse elements of different traditions by their own preference, one deal at a time, without a polity choosing for them. The &ldquo;-isms&rdquo; stop being package deals.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">

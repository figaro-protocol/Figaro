    ...
    return (
        <section className="container mx-auto px-6 pt-24 pb-16 max-w-2xl">
            ...
            <p className="text-sm text-ink-muted italic mb-8">
                One note before the mechanism: the network is pre-launch, so what follows describes how a deal works, not a marketplace running today.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">
                The short version is a lockbox: both sides put in a stake, more than the deal is worth. The lockbox is a small program that runs in the open, owned by no one, that holds the stakes and follows one fixed rule. Here is the exact version. Say the deal is worth ten tokens &mdash; a different amount than other worked examples on this site use; only the 2&times; ratio is ever fixed, never the number &mdash; any ERC20 (a standard kind of digital token) the participants accept, often a stablecoin, a token designed to hold a steady price. The buyer locks twenty &mdash; the ten they owe, and ten more of their own as a stake. The seller locks twenty too, all of it stake. Forty is now held, and until the deal is done, neither side can reach any of it.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">
            ...
            <p className="text-base text-ink-body leading-relaxed mb-5">
                It is worth being exact about what &ldquo;forfeit&rdquo; means, because it is not what it sounds like. No one judges the cheating, and nothing is ever seized &mdash; there is no authority here with the power to take anything. A forfeited stake is simply value that never comes home: the lockbox opens only when the buyer is satisfied, so if the other side abandons the deal entirely, it never closes &mdash; your own locked tokens stay locked, you eat that loss, and the one who walked away forfeits a stake worth double the deal, gone for good. That forfeited stake is not handed over to you; it stays locked in the box, benefiting no one. The math is exactly why this is rare: abandoning a deal always costs the one who abandons it more than finishing it ever could, so almost no one does.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">
                It is worth pausing on what kind of thing the stake is. Value you part with has always had two modes: spent, or invested. The stake is a third thing. It is neither consumed nor put to work earning &mdash; it is a promise made expensive to break, and it comes home intact every honest time.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">

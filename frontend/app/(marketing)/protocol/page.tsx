    ...
    return (
        <section className="container mx-auto px-6 pt-24 pb-16 max-w-2xl">
            ...
            <p className="text-base text-ink-body leading-relaxed mb-5">
                The short version is a lockbox: both sides put in a deposit, more than the deal is worth. The lockbox is a small program that runs in the open, owned by no one, that holds the deposits and follows one fixed rule. Here is the exact version. Say the deal is worth ten tokens &mdash; any ERC20 (a standard kind of digital token) the participants accept, often a stablecoin pegged to dollars. The buyer locks twenty &mdash; the ten they owe, and ten more of their own as a stake. The seller locks twenty too, all of it stake. Forty is now held, and until the deal is done, neither side can reach any of it.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">
            ...
            <p className="text-base text-ink-body leading-relaxed">
                That is the whole of it: a deposit large enough that cheating loses, and one clear rule for who opens the box. Everything else Figaro can do &mdash; carrying many kinds of agreement, linking long chains of contributors &mdash; is built on those two facts and changes neither. The hard part was never the machinery. It was making it simple enough that you never have to trust the person on the other side.
            </p>

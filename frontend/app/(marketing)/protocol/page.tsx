    ...
    return (
        <section className="container mx-auto px-6 pt-24 pb-16 max-w-2xl">
            ...
            <p className="text-base text-ink-body leading-relaxed mb-5">
                The short version is a lockbox: both sides put in a deposit, more than the deal is worth. Here is the exact version. Say the deal is worth ten. The buyer locks twenty &mdash; the ten they owe, and ten more of their own as a stake. The seller locks twenty too, all of it stake. Forty is now held, and until the deal is done, neither side can reach any of it.
            </p>
            <p className="text-base text-ink-body leading-relaxed mb-5">

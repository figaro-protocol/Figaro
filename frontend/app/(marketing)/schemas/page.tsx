        ...
        <>
            ...
            <MarketingSection title="Where to look">
                <ul className="space-y-3 text-sm text-ink-body leading-relaxed">
                    ...
                    <li><strong>Repository:</strong> <a href="https://github.com/figaro-protocol/Figaro" target="_blank" rel="noopener noreferrer" className="underline">github.com/figaro-protocol/Figaro</a>. The <code>CLAUDE.md</code> at the root is the authoritative inventory and carries the canonical schema-authoring checklist.</li>
                </ul>

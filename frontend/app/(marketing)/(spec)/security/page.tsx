    ...
    return (
        <>
            ...
            <MarketingSection title="The verification stack" sectionId="verification">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    What is in place today is a verification stack &mdash; five independent benches targeting the protocol&apos;s contracts from different angles. Five, and not one, because each catches a class of defect the others structurally cannot:
                </p>

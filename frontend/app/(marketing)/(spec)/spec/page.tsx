        ...
        <>
            ...
            <MarketingSection title="Install the SDK" sectionId="install">
                ...
                <p className="text-sm text-ink-muted leading-relaxed mb-4">
                    Honest scope: <code>@figaro-protocol/sdk</code> is not yet published to the npm registry &mdash; publication (with provenance attestation) is a tracked pre-release task. Until then, install from a repo checkout: <code>&quot;@figaro-protocol/sdk&quot;: &quot;file:../sdk&quot;</code> (build it first: <code>npm run build --workspace sdk</code> from the repo root).
                </p>

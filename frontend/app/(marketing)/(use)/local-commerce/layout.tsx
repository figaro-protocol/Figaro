...
export const metadata: Metadata = {
    ...
    twitter: {
        ...
        title: "Figaro Local Commerce",
        description: "One trade on Figaro Protocol, lived end to end. Both parties lock bonds before work begins; no company sits in the middle, because the trade secures itself.",
        images: [OG_IMAGE.url],
    },
};

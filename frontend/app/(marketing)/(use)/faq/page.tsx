        ...
        <>
            ...
            <MarketingSection title="Before your first real trade." sectionId="before-you-send">
                ...
                <ul className="space-y-3 text-base text-ink-body mb-5 ml-6">
                    ...
                    <li>&mdash; <strong className="text-ink-heading font-medium">Who holds the payment while the trade runs?</strong> No one &mdash; the payment and both bonds sit in a decentralized, permissionless contract with no path out but the resolution the buyer signs (<Link href="#custody" className="text-ink-heading font-medium hover:underline">who holds the tokens</Link>).</li>
                    ...
                    <li>&mdash; <strong className="text-ink-heading font-medium">What if I lose my key?</strong> The kernel has no recovery path of any kind &mdash; a buyer who set up an account-level recovery beforehand can still close active processes; a buyer who did not leaves the bonds locked, permanently (<Link href="#keys" className="text-ink-heading font-medium hover:underline">how to set it up, before you commit</Link>).</li>
                    <li>&mdash; <strong className="text-ink-heading font-medium">Can anyone freeze my funds or shut this down?</strong> There is no admin, owner, pause function, or upgrade key to hold; the exposure that remains is the chain itself (<Link href="#shutdown" className="text-ink-heading font-medium hover:underline">what has no privileged role</Link>).</li>
            ...
            <MarketingSection title="What if you lose your keys?" sectionId="keys">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-base text-ink-body leading-relaxed">
                    <li>Use a wallet that can install an EIP-7702 delegation on your address and lets you name a recovery authorisation for it &mdash; a second key, a guardian set, or a hardware device you hold separately. The wallet&apos;s own documentation is the authority on its steps; Figaro reads only the address.</li>
                    ...
                    <li>Keep the signing key itself in hardware-grade keeping, and keep the recovery authorisation somewhere the same accident cannot reach.</li>
            ...
            <MarketingSection title="Who can shut this down or freeze your funds?" sectionId="shutdown">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    No one. FigaroCore has no admin, no pause function, no upgrade key, no governance with discretionary power over tokens. The kernel does not contain code that any address can call to halt resolution, blacklist a participant, or move tokens it does not have a signed commitment against. There is nothing to capture because there is no privileged role to hold.
                </p>
                <p className="text-base text-ink-body leading-relaxed">

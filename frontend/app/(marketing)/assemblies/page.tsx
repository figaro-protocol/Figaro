...
export const metadata: Metadata = {
    ...
    description:
        "Composition templates anchored on AssemblyRegistry — each assembly wires schemas into a multi-order process. The inventory reads on-chain AssemblyRegistered events directly.",
};

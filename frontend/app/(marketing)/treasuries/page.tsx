        ...
        <>
            ...
            <section className="container mx-auto px-6 pb-24 max-w-3xl border-t border-gray-200 pt-12">
                ...
                <ul className="space-y-3 text-sm text-gray-700 leading-relaxed list-disc pl-6">
                    <li><strong>Counterparty bond required.</strong> The seller posts <code>2× cumulative value</code>. Counterparties without in-hand capital cannot enter without external financing &mdash; bond-financing is one of the compositional surfaces named on <Link href="/integrate" className="underline">/integrate</Link>.</li>

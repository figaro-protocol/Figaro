...
export default function Clauses() {
  ...
  "fields": [ { "name": "note", "type": "string", "required": true } ]
            ...
            <MarketingSection title="Registered clauses, by article.">
                <p className="text-sm text-ink-body leading-relaxed mb-6">
                    The reference set spans assembly topology, commerce primitives, emissions accounting and offsets, lifecycle and proximity, sovereign process logs, composition markers, and legal anchoring. Two &mdash; <code>figaro-topology-v1</code> and <code>figaro-descending-auction-v1</code> &mdash; are agreement-only: committed at agreement signing, with no on-chain validator.
                </p>
                <ClauseInventory />
            </MarketingSection>

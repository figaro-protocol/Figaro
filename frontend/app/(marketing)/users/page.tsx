        ...
        <>
            ...
            <MarketingSection title="First, a wallet.">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    Do one thing before your first order, not after: back up your key and turn on your wallet&apos;s recovery path (EIP-7702) while nothing is at stake yet. Set up in advance, a lost key can still close out your active deals from the same address; skipped, a lost key locks your stakes permanently &mdash; no way for Figaro or anyone else to restore them. How to set it up is on <Link href="/security" className="text-ink-heading font-medium hover:underline">security</Link>.
                </p>
            </MarketingSection>
            ...
            <MarketingSection title="What it costs.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    No platform stands between you and the seller taking a percentage &mdash; the seller keeps the whole price, because there is no company in the middle to pay and Figaro charges no fee. The only payment that leaves your hands for good is the network&apos;s own charge for running the transactions &mdash; the gas fee, small and per-step, that any activity on Ethereum pays &mdash; and it goes to the network, not to Figaro, which has no one to collect one. Both sides lock double; the full arithmetic is on <Link href="/protocol" className="text-ink-heading font-medium hover:underline">Protocol</Link>.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                    The same 2&times; rule holds at any size. A 2,000-token instrument works exactly the same way: both sides lock double, the same single rule closes it, the same recourse stands behind it. The size changes nothing but the stakes. If it ever needs a court, the judgment collects from the loser&apos;s other holdings, and the on-chain record is already there to make the case.
                </p>
            </MarketingSection>

            <MarketingSection title="Before you commit.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    If it ever does need a court, the judgment collects the ordinary way &mdash; from the loser&apos;s other holdings, not this locked stake.
                </p>
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    Two questions sit under both paths: who holds the tokens while a deal is open, and what happens if the other party defects? The short answers are <em>no one</em> and <em>the defector loses more than the honest party, every time</em> &mdash; bonded against the kernel directly, no custodian, no escrow account. Every deal&apos;s full record is publicly checkable at <Link href="/audit" className="text-ink-heading font-medium hover:underline">audit</Link>, so there is nothing to reconstruct. The longer answers, with every honest caveat, are at <Link href="/security" className="text-ink-heading font-medium hover:underline">security</Link>.
                </p>
                <p className="text-base text-ink-body leading-relaxed">

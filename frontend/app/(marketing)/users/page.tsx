        ...
        <>
            ...
            <MarketingSection title="First, a wallet.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    Before any of this, you need a wallet &mdash; an app that holds digital tokens and signs for you, the way a banking app holds a balance, except no bank runs it and you alone hold the key. You move ordinary money into it once, and inside the wallet it becomes tokens you can spend on-chain &mdash; often a stablecoin, a token designed to hold a steady price. From then on, a deal moves those. This step happens entirely in your wallet, before Figaro is involved at all: Figaro never touches your bank or your card &mdash; it only ever sees the wallet that signs.
                </p>
            ...
            <MarketingSection title="What it costs.">
                ...
                <p className="text-base text-ink-body leading-relaxed">
                    The stake is the mechanism, so it is worth being plain about what it ties up. To buy a dinner worth thirty tokens you need sixty tokens free: the thirty you are paying, and thirty more staked behind it. That stake is not spent &mdash; it is locked for the life of the deal, which for dinner is the length of one evening, and it returns in full the moment you confirm. Every honest deal gives the stake back; only walking away forfeits it. The doubled stake is precisely what buys you a deal with no platform in the middle and no cut taken out. Sellers and couriers live the same reality from their side: a courier who stakes against the whole meal has that stake held &mdash; ready and untouched, not spent &mdash; until the buyer confirms, then home in full like every other honest stake. The stake is twice the value on every side, always &mdash; it is the price of needing no one&apos;s permission and no one&apos;s trust.
                </p>
            </MarketingSection>

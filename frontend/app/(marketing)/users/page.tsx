    ...
    return (
        <>
            ...
            <MarketingSection title="What it costs.">
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    No platform stands between you and the seller taking a percentage &mdash; the seller keeps the whole price, because there is no company in the middle to pay and Figaro charges no fee. The only payment that leaves your hands for good is the network&apos;s own charge for running the transactions &mdash; the gas fee, small and per-step, that any activity on Ethereum pays &mdash; and it goes to the network, not to Figaro, which has no one to collect one. Both sides lock double; the full arithmetic is on <Link href="/kernel" className="text-ink-heading font-medium hover:underline">Kernel</Link>.
                </p>
                <p className="text-base text-ink-body leading-relaxed">

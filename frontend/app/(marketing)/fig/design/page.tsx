    ...
    return (
        <>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <ul className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-16 shrink-0 uppercase">Pure</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-16 shrink-0 uppercase">Pred</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-16 shrink-0 uppercase">Clean</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-16 shrink-0 uppercase">Decouple</span>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <ul className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Per-mint</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Pre-reg</span>
                    ...
                    <li className="flex gap-4">
                        <span className="font-mono text-xs text-gray-400 mt-1 w-24 shrink-0 uppercase">Renounce</span>
                ...
                <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    <div className="border border-gray-200 rounded-lg p-5">
                        <div className="flex items-baseline justify-between gap-3 mb-1">
                            ...
                            <span className="text-xs text-gray-500">Genesis, no vesting</span>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-5">
                        <div className="flex items-baseline justify-between gap-3 mb-1">
                            ...
                            <span className="text-xs text-gray-500">Three stages</span>
                        </div>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Focal-shift attack</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Dump attack</div>
                    ...
                    <div>
                        <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Acquiescence attack</div>

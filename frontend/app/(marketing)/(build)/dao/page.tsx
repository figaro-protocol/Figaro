    ...
    return (
        <>
            ...
            <MarketingSection title="A grant, not an income.">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    There are three ways to spend it, and nothing gates which. It can stand up a public-goods program &mdash; a grant, a bounty, a commons initiative &mdash; by ordinary transfer, decided and paid without a crowd, a round, or a matching formula anywhere in the loop. It can pay a third party for work done: design, an audit, anything an organization buys, an ordinary transfer on trust like any invoice. Or it can buy through the protocol as an ordinary bonded buyer &mdash; the treasury supplies an operator wallet that signs, since the kernel accepts only a key&apos;s own signature &mdash; when the payment should be secured by the mechanism rather than trusted. All three are acts of judgment, case by case; the counter that rewards by measured activity lives at the designer-rewards tier, never here.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                    That discretion is the entire point of having a human layer. The reserve that rewards <Link href="/rpgf" className="text-ink-heading font-medium hover:underline">designers</Link> refuses on principle to judge which contributions matter more than their use; a young network still needs someone willing to make exactly that judgment, and to be answerable for it.
                </p>
            </MarketingSection>
            ...
            <MarketingSection title="What it lives on afterwards, it earns.">
                ...
                <p className="text-base text-ink-body leading-relaxed mb-5">
                    One clause is excluded by name from earning anything: assembly provenance, the leaf that says which assembly a process ran and so credits its designer. It is the reward system&apos;s own attribution plumbing, and rewarding it would be the counter charging for reading itself. It counts; it never earns.
                </p>
                <p className="text-base text-ink-body leading-relaxed">
                    The alignment is in where the income comes from, not in a rule about how it goes out. The treasury is rewarded only when the network is used, so its interest is simply that the network is used. And the arrangement is not exclusive: anyone may out-design it on the same open registries, under their own wallet, on the same terms. A stranger who would rather donate a clause than keep it can register it under the treasury instead &mdash; that is what donating means here, and it is as permissionless and as permanent as any other registration.
                </p>
            </MarketingSection>

    ...
    return (
        <>
            ...
            <MarketingSection title="Reward Terms &amp; Conditions.">
                ...
                <RpgfValueLoopFigure />
                <p className="text-base text-ink-body leading-relaxed mt-6">
                    A designer reads their accrual and claims a closed period&apos;s share at <Link href="/rewards" className="text-ink-heading font-medium hover:underline">Claim rewards</Link> &mdash; connected wallet required, permission from no one. Claiming is one call per closed year, the wallet&apos;s whole portfolio in it &mdash; every clause and assembly listed together, once. A year pays only after it closes; what a closed year never pays out is never minted at all; and a claim never expires &mdash; a closed year waits as long as its designer does. The formula itself &mdash; the schedule, the two counters, the cube-root score &mdash; is stated in full on <Link href="/spec" className="text-ink-heading font-medium hover:underline">Specifications</Link>. What fabricating a score would cost &mdash; ETH linear in the score, priced by the stake, its cooldown, and the period &mdash; is derived in the <Link href="/papers/substrate-broadening-rpgf" className="text-ink-heading font-medium hover:underline">designer-rewards paper</Link>.
                </p>
            </MarketingSection>

            <MarketingSection title="Where the other 400 million sits." bottomPad="wide">
                <p className="text-base text-ink-body leading-relaxed">
                    The florin&apos;s supply is fixed at a billion, and this reserve is 600 million of it. 300 million sit in the <Link href="/dao" className="text-ink-heading font-medium hover:underline">DAO&apos;s treasury</Link>, spent by human judgment &mdash; a one-time grant to the human layer, a different object from the use-paid reserve above. 100 million went at genesis to the founders and early supporters &mdash; 70 and 30 respectively &mdash; as retroactive financing for the work already done: the same mechanism as this reserve at an earlier date. A florin is a Schelling point and carries no rights of any kind &mdash; no ownership interest, no influence, no vote, no claim on what others produce; the Tokenomics page below says what it is. The whole split is readable on the chain.
                </p>

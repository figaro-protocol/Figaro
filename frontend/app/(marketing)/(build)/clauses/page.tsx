        ...
        <>
            ...
            <MarketingSection title="Writing a clause.">
                <ul className="space-y-3 text-sm text-ink-body leading-relaxed list-disc pl-5">
                    ...
                    <li>It registers on <code>ClauseRegistry</code> &mdash; permissionless and first-write-wins &mdash; on the stake terms every registry here shares (<Link href="/faq#builders-registries" className="underline">what the stake does, and what withdrawing it leaves behind</Link>). What is specific to a clause binding: it is permanent per <code>(name, version)</code>, so withdrawing moves the stake and the listing but never the clause &mdash; agreements already committed against it keep resolving forever.</li>

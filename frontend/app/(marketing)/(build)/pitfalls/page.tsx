            ...
            <MarketingSection title="Read-time — after resolution.">
                <ul className="space-y-6">
                    <LabelledListRow label="orderStatus == 0" labelWidth="wide" uppercase>
                        ...
                        <div className="mt-2 text-sm">
                            <Link href="/spec#resolution-paths" className="text-ink-heading font-medium hover:underline">Full explanation &mdash; Specifications, &ldquo;The two paths share no state&rdquo;</Link>
                        </div>
                    </LabelledListRow>
                </ul>
            </MarketingSection>

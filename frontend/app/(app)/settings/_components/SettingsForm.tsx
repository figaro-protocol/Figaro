...
/**
 * SettingsForm — the interactive body of /settings (the wallet's own
 * runtime-infrastructure endpoints). The page shell (heading + subject
 * copy + prerendered <title>) lives in the sibling server `page.tsx`; this
 * client child carries only the mount-gated form so the static-export shell
 * still names its subject before hydration.
 *

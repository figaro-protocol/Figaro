    ...
    return (
        <>
            ...
            <p className="text-sm text-ink-faint leading-relaxed mb-6">
                For agents: the member listing derives from the live <code>MembersRegistry</code> and can be reconstructed programmatically with <code>reconstructDiscovery()</code> from <code>@figaro/sdk</code> &mdash; see <Link href="/integrate" className="underline">Integrate</Link> for the deployment record.
            </p>
            <MemberLanding />
        </>
    );

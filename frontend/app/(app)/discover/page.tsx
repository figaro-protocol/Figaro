...
export const metadata: Metadata = {
    ...
    description:
        "Browse bonded sellers across the Figaro ecosystem. Filter by your location, search by name, pick an assembly. Click an seller to open their assembly's runtime and start a bonded commitment.",
};
    ...
    return (
        <section className="container mx-auto px-6 pt-16 pb-24 max-w-5xl">
            ...
            <p className="text-base text-gray-600 leading-relaxed max-w-2xl mb-10">
                An seller is the agent &mdash; a person or a service &mdash;
                ...
                URI and one or more assembly bindings. Click an seller to open

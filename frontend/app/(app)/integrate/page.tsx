...
// — identical to what the contract itself holds.`}</pre>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    ...
                    <div className="border border-gray-200 rounded-lg p-5">
                        ...
                        <p>Accounting, tax-reporting, regulatory-filing tools that translate on-chain Figaro activity into jurisdictional formats. See <Link href="/accounting" className="underline hover:text-black">/accounting</Link> for the underlying ledger model.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 pb-16 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <ul className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    <li className="flex gap-4">
                        ...
                        <span><strong>Kleros, SIAC, ICC, courts.</strong> Parties&apos; agreement designates the forum; Figaro exports its evidence bundle there. Kernel does not adjudicate. See <Link href="/legal" className="underline hover:text-black">/legal</Link>.</span>
                    </li>
                    <li className="flex gap-4">
            ...
            <section className="container mx-auto px-6 pb-32 max-w-3xl border-t border-gray-100 pt-12">
                ...
                <p className="mt-8 text-sm text-gray-500">
                    ...
                    <Link href="/verification" className="underline hover:text-black">verification</Link>

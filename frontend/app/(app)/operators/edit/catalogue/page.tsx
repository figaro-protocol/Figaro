...
import { OperatorEditCatalogue } from "@/components/operators/OperatorEditCatalogue";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
    title: "Edit catalogue — Figaro Protocol",
    description: "Update the pinned catalogue document. Re-pins items to IPFS, then re-pins the operator profile pointing at the new catalogue CID, then dispatches OperatorRegistry.updateProfile.",
};

...
import { OperatorEditProfile } from "@/components/operators/OperatorEditProfile";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
    title: "Edit profile — Figaro Protocol",
    description: "Update the on-chain operator-profile metadata pointer. Re-pins the profile JSON to IPFS and calls OperatorRegistry.updateProfile; deposit and lock period are not touched.",
};

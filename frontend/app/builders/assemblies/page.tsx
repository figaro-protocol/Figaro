import { InstitutionAssemblyInspector } from "@/components/core/InstitutionAssemblyInspector";
        ...
        <section className="container mx-auto px-4 py-20">
            <div className="mx-auto mb-12 max-w-5xl">
                <p className="mb-3 text-xs font-semibold uppercase tracking-widest text-neutral-500">
                    Institution Assemblies
                </p>
                <h1 className="mb-4 text-5xl font-bold text-black">Browse Assemblies</h1>
                <p className="mb-4 max-w-3xl text-lg text-black">
                    An institution assembly is a packaged configuration of roles, mechanisms, policies,
                    and UI surfaces that the runtime renders into a live institution. Each assembly
                    below was validated against the{" "}
                    <Link href="/builders" className="underline hover:text-neutral-600">
                        assembly schema
                    </Link>{" "}
                    and projected into a derived institution model.
                </p>

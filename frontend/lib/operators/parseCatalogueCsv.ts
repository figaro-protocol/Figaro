/**
 * lib/operators/parseCatalogueCsv.ts
 *
 * Minimal RFC-4180-ish CSV parser scoped to the operator catalogue
 ...
 * fancier (BOM handling, custom delimiters, streaming) the operator

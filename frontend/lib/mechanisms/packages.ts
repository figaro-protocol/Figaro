...
export const FIG_MECHANISM_PACKAGE: MechanismPackage = {
    kind: FIG_MECHANISM_PACKAGE_METADATA.kind,
    capabilityBindings: FIG_MECHANISM_PACKAGE_METADATA.capabilityBindings,
    modules: [
        {
            moduleId: "fig-token",
            component: FigTokenModule,
        },
    ],
    hooks: {
        useFigTokenMetrics,

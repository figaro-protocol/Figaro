...
export type ScopeType = "institution" | "process" | "order" | "role" | "mechanism";
...
export interface InstitutionAssembly {
...
export const FIGARO_EATS_REFERENCE_ASSEMBLY = parseInstitutionAssemblyDocument(
    figaroEatsReference,
    "figaro-eats.reference.json"
);

export const FIGARO_PROCUREMENT_REFERENCE_ASSEMBLY = parseInstitutionAssemblyDocument(
...
export const FIGARO_EQUIPMENT_RENTAL_REFERENCE_ASSEMBLY = parseInstitutionAssemblyDocument(
    figaroEquipmentRentalReference,
    "figaro-equipment-rental.reference.json"
);

export const FIGARO_FREELANCE_REFERENCE_ASSEMBLY = parseInstitutionAssemblyDocument(
...
export const REFERENCE_ASSEMBLIES: InstitutionAssembly[] = [

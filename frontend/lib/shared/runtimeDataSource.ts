...
export { createRuntimeIdentityDataSourceFromManifestDocument } from '@/lib/shared/runtimeManifest';
...
export interface RuntimeIdentityDataSource {
    ...
    listInstitutionBindings(): InstitutionBindingRecord[];
    ...
    listValidationIssues?(): RuntimeIdentityManifestValidationIssue[];
...
export function resolveRuntimeSubjectByAddressFromSource(
    ...
    return resolveIdentityContext(
        ...
        dataSource.listInstitutionBindings(),
        networkTarget
    );
}
...
export function listSubjectProvenanceRecordsFromSource(
    ...
    const bindings = dataSource.listInstitutionBindings();

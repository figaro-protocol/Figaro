 ...
 *   - "figaro-ghg-disclosure-v1" → seller reports GHG emissions per ISO 14064
 *   - "figaro-proximity-v1" → seller supports proximity-proof handoff
...
export const SELLER_CATALOGUE_METADATA_EXAMPLE: SellerCatalogueMetadata = {
    ...
    supportedSchemas: [
        ...
        {
            schemaKey: "figaro-ghg-disclosure-v1",
            config: {
 ...
 * appear if the seller supports "figaro-ghg-disclosure-v1").
 */
 ...
 * e.g. sellerSchemaConfig(meta, "figaro-ghg-disclosure-v1")?.methodology
 */

 ...
 * `DiscoverButton` (consumer entry) and `BuildButton` (builder entry):
 * `ReadButton` is the protocol-reader entry. Used on the homepage as the
 * third doorway CTA; not currently used in headers.
 *

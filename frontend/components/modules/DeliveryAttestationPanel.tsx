...
import { QRChallengeDisplay } from "@/components/shared/QRChallengeDisplay";
import { QRChallengeScanner } from "@/components/shared/QRChallengeScanner";
...
export function DeliveryAttestationModule({ context }: ModuleProps) {
    if (context.selectedRoleKind !== "driver" || !context.processModel || !context.selectedOrder) {
        return null;
    }

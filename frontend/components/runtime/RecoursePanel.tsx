            ...
            {canBundle && (
                ...
                >
                    <button
                        ...
                        className="self-start px-3 py-1.5 text-xs font-medium rounded bg-ink-primary text-paper hover:bg-ink-body disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >

 ...
 * fuller numbered block (`app/(marketing)/page.tsx`) and this file's
 * `ReadingPathStrip` both render from this array, so the two tellings can
 * never diverge. Order and copy match the front page's telling verbatim —
 * do not restate the curriculum anywhere else.
 */

    ...
    return (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900">
            <div className="flex items-start justify-between gap-3">
                <div>
                    <p className="font-semibold mb-1">Welcome to the Figaro Workbench</p>
                    ...
                    <p className="mt-2 text-blue-700">
                        Read <a href="/why-figaro" className="underline hover:no-underline">Why Figaro</a> to understand the game theory behind self-enforcing agreements.
                    </p>
                </div>
                <button
                    onClick={dismiss}

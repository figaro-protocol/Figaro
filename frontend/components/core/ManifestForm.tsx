...
const FULFILMENT_OPTIONS = [
    ...
    { value: "pickup", label: "Pickup (buyer organizes)" },
    { value: "deliver:buyer-assigned", label: "Delivery (buyer chooses courier)" },
    { value: "deliver:seller-assigned", label: "Delivery (merchant arranges courier)" },
    { value: "deliver:dutch-auction", label: "Delivery (Dutch-auction courier)" },
] as const;

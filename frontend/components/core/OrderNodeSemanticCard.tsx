        ...
        <Card className="p-4">
            ...
            {order.parentOrderIds.length > 0 && (
                <div className="mb-3 rounded border border-neutral-200 bg-neutral-50 px-3 py-2">
                    <p className="text-xs font-semibold text-neutral-500 mb-1">Depends On</p>
            ...
            {order.attachments.length > 0 && (
                <div className="mb-3 rounded border border-neutral-200 bg-white px-3 py-2">
                    <p className="text-xs font-semibold text-neutral-500 mb-2">Runtime Semantics</p>
            ...
            {order.capabilities.length > 0 && (
                <div className="border-t border-neutral-200 pt-3">
                    <p className="text-xs font-semibold text-neutral-500 mb-2">Derived Actions</p>

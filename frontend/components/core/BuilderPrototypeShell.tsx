...
export function BuilderPrototypeShell({ slug, runtimeManifestUrl }: Props) {
    ...
    if (!artifact) {
        ...
        return (
            <div className="rounded-lg border border-neutral-200 bg-white p-6 text-black">
                ...
                <h2 className="text-2xl font-bold mb-2">Unknown institution slug</h2>
                <p className="text-sm text-neutral-600 mb-4">
                    No registered institution artifact matched <span className="font-mono">{slug}</span>.
                </p>
    ...
    return (
        <div className="space-y-6">
            {runtimeContext.boundSubjects.length > 0 || activeRuntimeManifestUrl || runtimeSourceError ? (
                <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-5 text-black">
                    ...
                    <div className="mb-4 rounded border border-neutral-200 bg-white p-3 text-sm text-black">
                        <p className="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-2">Runtime Manifest</p>
                    ...
                    <div className="mb-4 rounded border border-neutral-200 bg-white p-3 text-sm text-black">
                        ...
                        {runtimeSourceStatus === "remote" ? (
                            <p className="text-neutral-600">Using fetched runtime manifest for this prototype view.</p>
                        ) : null}
            ...
            <InstitutionArtifactWorkspace artifact={artifact} runtimeContext={runtimeContext} />
        </div>
    );
}
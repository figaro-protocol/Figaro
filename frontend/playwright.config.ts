...
export default defineConfig({
    ...
    projects: [
        ...
        },
        {
            ...
            testMatch: /(permissionless-clause|clause-coverage|assembly-withdraw)\.devnet\.spec\.ts$/,
            fullyParallel: false,
            workers: 1,
            use: { ...devices['Desktop Chrome'] },
        },
        {
            ...
            testIgnore: /(sellers-onboarding|permissionless-clause|clause-coverage|assembly-withdraw)\.devnet\.spec\.ts$/,

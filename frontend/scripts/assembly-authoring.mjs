...
export function buildAssemblyDocument({ name, slug, description, assemblyClass, compositionLevel }) {
    ...
    return {
        ...
        narrative: {
            assemblySummary: `${name} as a composed institution built from authored assembly metadata and shared semantic modules.`,
...
export function cloneAssemblyDocumentFromSource(sourceDocument, { name, slug, description, assemblyClass, compositionLevel, sourceSlug }) {
    ...
    if (cloned.narrative) {
        cloned.narrative = {
            ...cloned.narrative,
            assemblySummary: `${name} as a scaffold cloned from ${sourceSlug} and adapted through authored assembly metadata and shared semantic modules.`,

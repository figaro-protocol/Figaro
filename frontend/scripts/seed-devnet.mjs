...
// The three local-commerce variants differ only in courier coordination:
...
const SELLERS = [
    ...
    { addressIndex: 7, name: 'Swift Courier', specialty: 'last-mile delivery', bind: ['local-commerce'], deliveryCatalogue: true, geohash: 'dr5regw3' },
    {
        ...
        bind: ['direct-sale', 'local-commerce', 'local-commerce-dutch', 'local-commerce-buyer-assigned', 'local-commerce-pickup'],
        couriers: [7],
        geohash: 'dr5regw7',
    },
